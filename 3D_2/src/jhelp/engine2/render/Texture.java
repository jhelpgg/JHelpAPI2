...
import jhelp.engine2.util.ColorsUtil;
import jhelp.engine2.util.CompressiveImage;
...
public class Texture
{
     ...
     * Font render context
     */
    public final static FontRenderContext CONTEXT                  = new FontRenderContext(Texture.TRANSFORM, false,
                                                                                           false);
     ...
     */
    public static double[] PCubiques(
            final double cp, final double p1, final double p2, final double p3, final int precision)
    {
     ...
     */
    public static @NotNull Texture load(final @NotNull File file)
    {
     ...
     */
    public static @Nullable Texture obtainTexture(final @NotNull String name)
    {
        if (name == null)
        {
     ...
     */
    public static @NotNull Texture obtainTextureForPickUV()
    {
    ...
    public static void refreshAllTextures()
    {
        ...
        for (final Texture texture : new EnumerationIterator<>(Texture.hashtableTextures.elements()))
        {
            texture.flush();
        }
    }
     ...
     */
    private static void registerTexture(final @NotNull Texture texture)
    {
        if (Texture.hashtableTextures == null)
        {
            Texture.hashtableTextures = new Hashtable<>();
        }
     ...
     */
    public static void renameTexture(final @NotNull Texture texture, @NotNull String newName)
    {
        if (texture == null)
        {
     ...
     */
    private static void unregisterTexture(final @NotNull Texture texture)
    {
        if (Texture.hashtableTextures == null)
        {
            return;
     ...
     *
     * @param name      Texture name
     * @param reference Texture reference
     */
    Texture(@NotNull String name, final @NotNull String reference)
    {
        if (name == null)
        {
            throw new NullPointerException("name mustn't be null");
     ...
     *
     * @param name          Texture name
     * @param bufferedImage Base image
     */
    public Texture(final @NotNull String name, final @NotNull BufferedImage bufferedImage)
    {
     ...
     */
    public Texture(final @NotNull String name, final @NotNull Icon icon)
    {
     ...
     */
    public Texture(final @NotNull String name, final @NotNull Image image)
    {
     ...
     * @param height Height
     */
    public Texture(final @NotNull String name, final int width, final int height)
    {
     ...
     * @param pixels Pixels
     */
    public Texture(final @NotNull String name, final int width, final int height, final @NotNull byte[] pixels)
    {
     ...
     * @param width  Width
     * @param height Height
     * @param color  Color for fill texture
     */
    public Texture(final @NotNull String name, final int width, final int height, final @NotNull Color color)
    {
        this(name, width, height, new byte[width * height * 4]);
        this.videoMemoryId = -1;
     ...
     * @param color  Color for fill texture
     */
    public Texture(final @NotNull String name, final int width, final int height, final int color)
    {
     ...
     * @param pixels Pixels
     */
    public Texture(final @NotNull String name, final int width, final int height, final @NotNull int[] pixels)
    {
        this(name, Texture.REFERENCE_PIXELS);
        this.videoMemoryId = -1;
        this.needToRefresh = true;
     ...
     *
     * @param name  Texture name
     * @param image Image to base on
     */
    public Texture(final @NotNull String name, final @NotNull JHelpImage image)
    {
     ...
     * @param name        Texture name
     * @param reference   Texture reference
     * @param inputStream Stream to read the texture
     * @throws IOException On reading problem
     */
    public Texture(final @NotNull String name, final @NotNull String reference, final @NotNull InputStream inputStream)
            throws IOException
    {
     ...
     */
    private void draw(
            final @NotNull PathIterator path, final @NotNull Color color, final boolean mix, final int precision)
    {
        double x, y, dx, dy;
        x = y = dx = dy = 0;
    ...
    private void drawImage(
            int x, int y, final @NotNull byte[] pixels, int width, int height, final boolean mayTransparent)
    {
        int  imageWidth;
        int  pixThis;
        int  pixImage;
     ...
     */
    private void drawImage(
            final int x, final int y, final @NotNull int[] pixels, final int width, final int height,
            final boolean mayTransparent)
    {
        byte[] bytePixels;
        int    nb;
        int    index;
     ...
     * @param a  Alpha
     */
    private void drawLineWithMix(
            int x1, int y1, final int x2, final int y2, final byte r, final byte g, final byte b, final byte a)
    {
     ...
     * @param a  Alpha
     */
    private void drawLineWithoutMix(
            int x1, int y1, final int x2, final int y2, final byte r, final byte g, final byte b, final byte a)
    {
        int p;
        int dx = x2 - x1;
     ...
     */
    private void draws(
            final @NotNull double[] x, final @NotNull double[] y, final @NotNull Color color, final boolean mix)
    {
     ...
     * @param height Height
     */
    private void fillRectWithMix(
            final byte r, final byte g, final byte b, final byte a, final int x, final int y, final int width,
            final int height)
    {
     ...
     */
    private void fillRectWithMix(
            final int redTopLeft, final int greenTopLeft, final int blueTopLeft, final int alphaTopLeft,//
            ...
            final int x, final int y, final int width, final int height)
    {
        ...
        for (int yy = 0, ay = height - 1; yy < height; yy++, ay--)
        {
            ...
            {
                alp = (((((alphaTopLeft * ax) + (alphaTopRight * xx)) * ay) +
                        (((alphaBottomLeft * ax) + (alphaBottomRight * xx)) * yy)) / div);
                pla = 255 - alp;

                this.pixels[index] = this.mix(this.pixels[index],
                                              (((((redTopLeft * ax) + (redTopRight * xx)) * ay) +
                                                (((redBottomLeft * ax) + (redBottomRight * xx)) * yy)) / div), alp,
                                              pla);
                this.pixels[index + 1] = this.mix(this.pixels[index + 1],
                                                  (((((greenTopLeft * ax) + (greenTopRight * xx)) * ay) +
                                                    (((greenBottomLeft * ax) + (greenBottomRight * xx)) * yy)) / div),
                                                  alp, pla);
                this.pixels[index + 2] = this.mix(this.pixels[index + 2],
                                                  (((((blueTopLeft * ax) + (blueTopRight * xx)) * ay) +
                                                    (((blueBottomLeft * ax) + (blueBottomRight * xx)) * yy)) / div),
                                                  alp, pla);
                this.pixels[index + 3] = this.add(this.pixels[index + 3], alp);
     ...
     * @param height Height
     */
    private void fillRectWithoutMix(
            final byte r, final byte g, final byte b, final byte a, final int x, final int y, final int width,
            final int height)
    {
        int       line = (x + (y * this.width)) << 2;
            ...
            final int x, final int y, final int width, final int height)
    {
        ...
        for (int yy = 0, ay = height - 1; yy < height; yy++, ay--)
        {
            ...
            for (int xx = 0, ax = width - 1; xx < width; xx++, ax--)
            {
                this.pixels[index++] = (byte) (((((redTopLeft * ax) + (redTopRight * xx)) * ay) +
                                                (((redBottomLeft * ax) + (redBottomRight * xx)) * yy)) / div);
                this.pixels[index++] = (byte) (((((greenTopLeft * ax) + (greenTopRight * xx)) * ay) +
                                                (((greenBottomLeft * ax) + (greenBottomRight * xx)) * yy)) / div);
                this.pixels[index++] = (byte) (((((blueTopLeft * ax) + (blueTopRight * xx)) * ay) +
                                                (((blueBottomLeft * ax) + (blueBottomRight * xx)) * yy)) / div);
                this.pixels[index++] = (byte) (((((alphaTopLeft * ax) + (alphaTopRight * xx)) * ay) +
                                                (((alphaBottomLeft * ax) + (alphaBottomRight * xx)) * yy)) / div);
            }
            line += w;
        }
     ...
     * @param height Height
     */
    private void fillWithMix(
            final @NotNull Shape shape, final byte r, final byte g, final byte b, final byte a, final int x,
            final int y,
            final int width,
            final int height)
    {
     ...
     * @return Result
     */
    private int limit0_255(final double value)
    {
     ...
     */
    void pixelsFromByteBuffer(final int width, final int height)
    {
     ...
     * @param height New texture height
     */
    void pixelsFromFloatBuffer(final int width, final int height)
    {
    ...
    void removeFromMemory()
    {
        if (this.videoMemoryId >= 0)
        {
            ...
            BufferUtils.TEMPORARY_INT_BUFFER.rewind();
            GL11.glDeleteTextures(BufferUtils.TEMPORARY_INT_BUFFER);
     ...
     */
    public void addTexture(final @NotNull Texture texture)
    {
     ...
     */
    public void applyAlphaMap(final @NotNull Texture texture)
    {
    ...
    public void bind()
    {
        ...
        if (this.videoMemoryId < 0)
        {
            ...
            {
                final IntBuffer textureID = stack.mallocInt(1);
        ...
        if (this.needToRefresh)
        {
            ...
            GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, this.width, this.height, 0, GL11.GL_RGBA,
                              GL11.GL_UNSIGNED_BYTE, BufferUtils.transferByte(this.pixels));
        }
    ...
    public void changeBright(final float factor)
    {
        ...
        for (int i = 0; i < nb; i += 4)
        {
            ...
            y *= factor;
            //
            r = ColorsUtil.limit0_255((y - (0.0009267 * (u - 128))) + (1.4016868 * (v - 128)));
            g = ColorsUtil.limit0_255(y - (0.3436954 * (u - 128)) - (0.7141690 * (v - 128)));
            b = ColorsUtil.limit0_255(y + (1.7721604 * (u - 128)) + (0.0009902 * (v - 128)));
            //
     ...
     */
    public void clear(final @NotNull Color color)
    {
     ...
     */
    public void contTexture(final @NotNull Texture texture)
    {
        if ((texture.width != this.width) || (texture.height != this.height))
        {
            throw new IllegalArgumentException("The given texture must have same size than this texture");
    ...
    public void contrast(final float factor)
    {
        ...
        int red   = this.pixels[index++] & 0xFF;
        int green = this.pixels[index++] & 0xFF;
        int blue  = this.pixels[index++] & 0xFF;

        index++;

        double    ymin = (0.299 * red) + (0.587 * green) + (0.114 * blue);
        double    ymax = ymin;
        final int nb   = this.width * this.height;

        for (int i = 1; i < nb; i++)
        {
            red = this.pixels[index++] & 0xFF;
            green = this.pixels[index++] & 0xFF;
            blue = this.pixels[index++] & 0xFF;
            index++;

            final double y = (0.299 * red) + (0.587 * green) + (0.114 * blue);
            if (y < ymin)
            {
                ymin = y;
            }
        ...
        {
            red = this.pixels[index] & 0xFF;
            green = this.pixels[index + 1] & 0xFF;
            blue = this.pixels[index + 2] & 0xFF;

            double y = (0.299 * red) + (0.587 * green) + (0.114 * blue);
            y = ymil + (factor * (y - ymil));
            final double u = ((-0.169 * red) - (0.331 * green)) + (0.500 * blue);
            final double v = (0.500 * red) - (0.419 * green) - (0.081 * blue);

            this.pixels[index++] = (byte) this.limit0_255((y - (0.0009267 * u)) + (1.4016868 * v));
            this.pixels[index++] = (byte) this.limit0_255(y - (0.3436954 * u) - (0.7141690 * v));
            this.pixels[index++] = (byte) this.limit0_255(y + (1.7721604 * u) + (0.0009902 * v));
            index++;
        }
     ...
     * For remove texture prefer use  {@link Window3D#removeFromMemory(Texture)}
     */
    public void destroy()
    {
        if (this.videoMemoryId >= 0)
        {
            Debug.warning("Can't delete texture already goes in video memory. Name=", this.textureName);
     ...
     */
    public void divTexture(final @NotNull Texture texture)
    {
        if ((texture.width != this.width) || (texture.height != this.height))
        {
     ...
     */
    public void draw(
            final @NotNull GlyphVector glyph, final int x, final int y, final @NotNull Color color, final boolean mix,
            final int precision)
    {
     ...
     * @param precision Precision
     */
    public void draw(final @NotNull Shape shape, final @NotNull Color color, final boolean mix, int precision)
    {
        if (precision < 2)
        {
            precision = 2;
     ...
     */
    public void drawImage(final int x, final int y, final @NotNull BufferedImage image)
    {
        int     width;
        int     height;
        int[]   pixels;
     ...
     * @param image Image to draw
     */
    public void drawImage(final int x, final int y, final @NotNull Image image)
    {
        ...
        {
            Debug.exception(e, "Issue while extracting pixels");
        }
     ...
     * @param image Image to draw
     */
    public void drawImage(final int x, final int y, final @NotNull JHelpImage image)
    {
        final int   width  = image.getWidth();
        final int   height = image.getHeight();
        final int[] pixels = image.getPixels(0, 0, width, height);
    ...
    public void drawLine(
            final int x1, final int y1, final int x2, final int y2, final @NotNull Color color, final boolean mix)
    {
        final byte r = (byte) color.getRed();
        final byte g = (byte) color.getGreen();
        final byte b = (byte) color.getBlue();
     ...
     */
    public void drawPixel(final int x, final int y, final @NotNull Color color, final boolean mix)
    {
    ...
    public void drawRect(
            final int x, final int y, final int width, final int height, final @NotNull Color color, final boolean mix)
    {
    ...
    public void drawString(
            final int x, final int y, final @NotNull String text, final @NotNull Color color, final @NotNull Font font,
            final boolean mix,
            final int precision)
    {
    ...
    public void drawTexture(
            final int x, final int y, final @NotNull Texture texture, int xTexture, int yTexture, int width, int height)
    {
        byte[] pixels;
        int    nb;
        int    yy;
     ...
     * @param mix   Enable/disable mixing mode
     */
    public void fill(final @NotNull Shape shape, final @NotNull Color color, final boolean mix)
    {
        final byte      r         = (byte) color.getRed();
        final byte      g         = (byte) color.getGreen();
        final byte      b         = (byte) color.getBlue();
     ...
     * @param mix    Enable/disable mixing mode
     */
    public void fillRect(int x, int y, int width, int height, final @NotNull Color color, final boolean mix)
    {
        final byte a = (byte) color.getAlpha();
    ...
    public void fillRect(
            int x, int y, int width, int height, final @NotNull Color colorTopLeft, final @NotNull Color colorTopRight,
            final @NotNull Color colorBottomLeft,
            final @NotNull Color colorBottomRight, final boolean mix)
    {
     ...
     */
    public void multiplyTexture(final @NotNull Texture texture)
    {
        if ((texture.width != this.width) || (texture.height != this.height))
        {
            throw new IllegalArgumentException("The given texture must have smae size than this texture");
     ...
     */
    public @NotNull Texture obtainParcel(int x, int y, int width, int height, @NotNull String suffixName)
    {
     ...
     * @return {@code true} if exactly the same
     */
    public boolean sameTexture(final @NotNull Texture texture)
    {
     ...
     */
    public void setImage(final @NotNull JHelpImage image)
    {
        final int   width  = image.getWidth();
        final int   height = image.getHeight();
        final int[] pixels = image.getPixels(0, 0, width, height);
     ...
     */
    public void setPixels(final int width, final int height, final @NotNull byte[] pixels)
    {
     ...
     * @param pixels New pixels
     */
    public void setPixels(final int width, final int height, final @NotNull int[] pixels)
    {
     ...
     */
    public void setPixels(final @NotNull Texture texture)
    {
        if ((this.width != texture.width) || (this.height != texture.height))
        {
     ...
     */
    public void subTexture(final @NotNull Texture texture)
    {
        if ((texture.width != this.width) || (texture.height != this.height))
        {
            throw new IllegalArgumentException("The given texture must have same size than this texture");
     ...
     * @return textureName
     */
    public @NotNull String textureName()
    {
     ...
     * @return textureReference
     */
    public @NotNull String textureReference()
    {
     ...
     */
    public void textureReference(final @NotNull String textureReference)
    {
        if (textureReference == null)
        {
            throw new NullPointerException("textureReference mustn't be null");
        }
     ...
     */
    public @NotNull CompressiveImage toCompressiveImage()
    {
    ...
    public void toGray()
    {
        ...
        for (int i = 0; i < nb; i += 4)
        {
            ...
            y = (r * 0.299) + (g * 0.587) + (b * 0.114);
            //
            c = (byte) ColorsUtil.limit0_255(y);
            //
            this.pixels[i] = c;
            this.pixels[i + 1] = c;
            this.pixels[i + 2] = c;
    ...
    public void toGrayInvert()
    {
        ...
        for (int i = 0; i < nb; i += 4)
        {
            ...
            y = (r * 0.299) + (g * 0.587) + (b * 0.114);
            //
            c = (byte) (255 - ColorsUtil.limit0_255(y));
            //
            this.pixels[i] = c;
            this.pixels[i + 1] = c;
            this.pixels[i + 2] = c;
     ...
     */
    public @NotNull JHelpImage toJHelpImage()
    {
        final int   nb     = this.width * this.height;
     ...
     */
    public @NotNull JHelpImage toJHelpImage(final int width, final int height)
    {
        final int   nb     = this.width * this.height;
        final int[] pixels = new int[nb];
