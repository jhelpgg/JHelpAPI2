...
public class VirtualBox
{
     ...
     */
    public void add(final @NotNull VirtualBox virtualBox)
    {
        if (virtualBox.empty())
        {
            return;
     ...
     */
    public void add(final @NotNull VirtualBox virtualBox, final float vx, final float vy, final float vz)
    {
        if (virtualBox.empty())
        {
            return;
    ...
    public String toString()
    {
        ...
        return UtilText.concatenate("VirtualBox [", this.minX, ", ", this.minY, ", ", this.minZ, "] x [", this.maxX,
                                    ", ", this.maxY, ", ", this.maxZ, ']');
    }
     ...
     */
    public void translate(final @NotNull Point3D vector)
    {
