...
public class CompressiveImage
{
     ...
     * @param bufferedImage Image to encode
     * @return Encoded image
     */
    public static CompressiveImage encode(final @NotNull String name, final @NotNull BufferedImage bufferedImage)
    {
     ...
     */
    public static @NotNull CompressiveImage encode(final @NotNull String name, final @NotNull Image image)
    {
     ...
     * @return Encoded image
     */
    public static @NotNull CompressiveImage encode(
            final @NotNull String name,
            final int width, final int height, final @NotNull byte[] pixels)
    {
        final CompressiveImage compressiveImage = new CompressiveImage(name);
        compressiveImage.setPixels(width, height, pixels);
        return compressiveImage;
     ...
     * @return Encoded image
     */
    public static CompressiveImage encode(
            final @NotNull String name,
            final int width, final int height, @NotNull final int[] pixels)
    {
        final CompressiveImage compressiveImage = new CompressiveImage(name);
        compressiveImage.setPixels(width, height, pixels);
        return compressiveImage;
     ...
     */
    private static int limit0_255(final int integer)
    {
        if (integer <= 0)
        {
            return 0;
     ...
     * The method return immediately, the background process is just started
     *
     * @param name             Image name
     * @param inputStream      Stream to read
     * @param textureToRefresh Texture to update on reading. If {@code null} no texture is update now, it can be set later
     * @return Encoded image
     * @throws IOException On reading problem
     */
    public static @NotNull CompressiveImage read(
            final @NotNull String name, final @NotNull InputStream inputStream,
            final @Nullable Texture textureToRefresh)
            throws IOException
    {
        if (inputStream == null)
        {
            throw new NullPointerException("The inputStream mustn't be null !");
        }
        ...
        ThreadManager.parallel(compressiveImage::readStream);
        return compressiveImage;
    }
     ...
     * @param name Image name
     */
    private CompressiveImage(final @NotNull String name)
    {
        if (name == null)
        {
    ...
    /**
     * Read the image from stream in background.
     */
        ...
        try
        {
            ...
            for (int yy = 0; yy < this.height; yy += 2)
            {
                ...
                for (int xx = 0; xx < this.width; xx += 2)
                {
                    ...
                    // Create each pixel
                    this.pixels[p00++] = (byte) (CompressiveImage.limit0_255((int) (y00 + uvR)));
                    this.pixels[p00++] = (byte) (CompressiveImage.limit0_255((int) (y00 + uvG)));
                    this.pixels[p00++] = (byte) (CompressiveImage.limit0_255((int) (y00 + uvB)));
                    this.pixels[p00] = (byte) (255);

                    this.pixels[p10++] = (byte) (CompressiveImage.limit0_255((int) (y10 + uvR)));
                    this.pixels[p10++] = (byte) (CompressiveImage.limit0_255((int) (y10 + uvG)));
                    this.pixels[p10++] = (byte) (CompressiveImage.limit0_255((int) (y10 + uvB)));
                    this.pixels[p10] = (byte) (255);

                    this.pixels[p01++] = (byte) (CompressiveImage.limit0_255((int) (y01 + uvR)));
                    this.pixels[p01++] = (byte) (CompressiveImage.limit0_255((int) (y01 + uvG)));
                    this.pixels[p01++] = (byte) (CompressiveImage.limit0_255((int) (y01 + uvB)));
                    this.pixels[p01] = (byte) (255);

                    this.pixels[p11++] = (byte) (CompressiveImage.limit0_255((int) (y11 + uvR)));
                    this.pixels[p11++] = (byte) (CompressiveImage.limit0_255((int) (y11 + uvG)));
                    this.pixels[p11++] = (byte) (CompressiveImage.limit0_255((int) (y11 + uvB)));
     ...
     * @param pixels Pixels
     */
    private void setPixels(final int width, final int height, final @NotNull int[] pixels)
    {
     ...
     * @param pixels Pixels
     */
    private void setPixels(final int width, final int height, final @NotNull byte[] pixels)
    {
     ...
     *
     * @param texture Texture to transfer (If it is {@code null} a new texture is created)
     * @return Updated texture
     */
    public @NotNull Texture transferToTexture(@Nullable Texture texture)
    {
        if (texture == null)
        {
    ...
    public void write(final @NotNull OutputStream outputStream) throws IOException
    {
        ...
        for (index = 0; index < nb; index++)
        {
            ...
            y[index] = CompressiveImage.limit0_255(((299 * r) + (587 * g) + (114 * b)) / 1000);
            cb[index] = CompressiveImage.limit0_255(((((-169 * r) - (331 * g)) + (500 * b)) / 1000) + 128);
            cr[index] = CompressiveImage.limit0_255((((500 * r) - (419 * g) - (81 * b)) / 1000) + 128);
        }

        // We write value by square 2x2 pixels
        int s0, s1, p00, p01, p10, p11;
        ...
        for (int yy = 0; yy < this.height; yy += 2)
        {
            ...
            for (int xx = 0; xx < this.width; xx += 2)
            {
                ...
                // So here we wrote 6 bytes, in RGB we should have to write 12, that's why it is smaller
            }
        }
        // Close the stream
