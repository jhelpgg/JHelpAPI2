...
public class Math3D
{
     ...
     */
    public static final  int   MAXIMUM_NUMBER_OF_OBJECTS = (256 * 256 * 256) / Math3D.PICKING_PRECISION;
    /**
    ...
    public static int[] computePowerOf2couple(final int integer)
    {
        ...
        while ((start + 1) < end)
        {
            ...
            final int power  = Math3D.powerOf2[middle];
     ...
     * @return Copy
     */
    public static final @NotNull float[] copy(final @NotNull float[] array)
    {
        if (array == null)
        {
            return null;
     ...
     * @return Copy
     */
    public static final @NotNull int[] copy(final @NotNull int[] array)
    {
        if (array == null)
        {
            return null;
     ...
     * @return Radian angle
     */
    public static float degreeToRadian(final float degree)
    {
        return (Math3D.TWO_PI * degree) / 360f;
    }
     ...
     * @return Distance between them
     */
    public static float distance(final @NotNull Point2D p1, final @NotNull Point2D p2)
    {
        return Math3D.distance(p1.x(), p1.y(), p2.x(), p2.y());
    }
     ...
     * @return Distance between them
     */
    public static float distance(final @NotNull Point3D p1, final @NotNull Point3D p2)
    {
     ...
     * @return Degre angle
     */
    public static float radianToDegree(final float radian)
    {
     ...
     */
    public static @NotNull Point3D symetric(final @NotNull Point3D point, final @NotNull Point3D center)
    {
