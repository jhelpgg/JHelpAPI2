...
public class ColorsUtil
{
     ...
     * @param factor Bright factor (factor>1 => more bright | 0<factor<1 => more dark)
     * @return Computed color
     */
    public static @NotNull Color changeBright(final @NotNull Color color, final float factor)
    {
        // Get color parts
        ...
        // Convert to RGB
        red = ColorsUtil.limit0_255((y - (0.0009267 * (u - 128))) + (1.4016868 * (v - 128)));
        green = ColorsUtil.limit0_255(y - (0.3436954 * (u - 128)) - (0.7141690 * (v - 128)));
        blue = ColorsUtil.limit0_255(y + (1.7721604 * (u - 128)) + (0.0009902 * (v - 128)));
     ...
     */
    public static int limit0_255(final double number)
    {
     ...
     */
    public static @NotNull Color moreBright(final @NotNull Color color)
    {
     ...
     * @return Darker color
     */
    public static @NotNull Color moreDark(final @NotNull Color color)
    {
