...
import jhelp.engine2.geometry.event.Ribbon3DListener;
        ...
        extends Object3D
{
     ...
     *
     * @param torsioCount Number of rotation
     */
     ...
     *
     * @param torsioCount Number of rotation
     * @param multU       U multiplier to repeat texture along the loop
     * @param multV       V multiplier to repeat texture along the "height"
     */
     ...
     * @param multU            U multiplier to repeat texture along the loop
     * @param multV            V multiplier to repeat texture along the "height"
     * @param ribbon3dListener Listener to alert when ribbon finished to create. If {@code null} no listener is register
     */
    public Ribbon3D(
            final int torsioCount, final float multU, final float multV,
            final @Nullable Ribbon3DListener ribbon3dListener)
    {
     ...
     */
    public Ribbon3D(
            final int torsioCount, final int precision, final float multU, final float multV,
            final @Nullable Ribbon3DListener ribbon3dListener)
    {
        ...
        ThreadManager.parallel(this.createRibbon);
    }
     ...
     * @param ribbon3dListener Listener to alert when ribbon finished to create. If {@code null} no listener is register
     */
    public Ribbon3D(final int torsioCount, final int precision, final @Nullable Ribbon3DListener ribbon3dListener)
    {
     ...
     * @param ribbon3dListener Listener to alert when ribbon finished to create. If {@code null} no listener is register
     */
    public Ribbon3D(final int torsioCount, final @Nullable Ribbon3DListener ribbon3dListener)
    {
    ...
    void createRibbon()
    {
        ...
        float           anRot              = 0;
        final float     zTranslationFactor = step * (this.torsioCount % 2) * Math2.sign(this.torsioCount);
