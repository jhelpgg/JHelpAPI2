 ...
 */
public class AnimationTextureGif
{
    /**
     * Launch the sample
     *
    ...
    public static void main(String[] args)
    {
        ...
        {
            //Load the texture
            Texture texture = Tool3D.loadGifTexture(window3D,
                                                    "wink",
                                                    AnimationTextureGif.class.getResourceAsStream("wink.gif"));
        ...
        File directory = new File("/home/jhelp/IdeaProjects/ia/3D_2/doc/tutorials/images/animTextureGif");
