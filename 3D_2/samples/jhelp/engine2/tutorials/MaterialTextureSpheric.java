...
/**
 * Code for "03_Materials" tutorial for texture
 */
public class MaterialTextureSpheric
{
    /**
     * Launch the sample
     *
    ...
    public static void main(String[] args)
    {
        ...
        Window3D window3D = Window3D.createSizedWindow(800, 600, "03_Materials spherical reflexion", true);
        ...
        try
        {
            ...
            Texture texture = new Texture("Rock", Texture.REFERENCE_RESOURCES,
                                          MaterialTextureSpheric.class.getResourceAsStream("TextureRock.png"));
