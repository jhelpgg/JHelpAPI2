...
public class SampleDynamicAnimation
{
    ...
    public static void main(final String[] args)
    {
        try
        {
            ...
            final JHelpImage flag = JHelpImage.loadImageThumb(
                    SampleDynamicAnimation.class.getResourceAsStream("001-Fog01.png"), 512, 256);
            final JHelpImage flag2 = JHelpImage.loadImageThumb(
                    SampleDynamicAnimation.class.getResourceAsStream("floor068.jpg"), 512, 256);
            final ImageTransition imageTransition = new ImageTransition(
                    JHelpDynamicImage.FPS * SampleDynamicAnimation.TIME_CHANGE_IMAGE, flag, flag2,
                    Integer.MAX_VALUE, true);
            final FlagAnimation flagAnimation = new FlagAnimation(0, 128, imageTransition.getInterpolated(), 2,
                                                                  10, JHelpDynamicImage.FPS / 2f);
            final AnimationPosition animationPosition = new AnimationPosition(flagAnimation, Integer.MAX_VALUE,
                                                                              Interpolations.SINUS);
            animationPosition.addFrame(0, new Position(0, 128));
            animationPosition.addFrame(JHelpDynamicImage.FPS * SampleDynamicAnimation.TIME_ACROSS_SCREEN,
                                       new Position(2048 - 512, 128));
            animationPosition.addFrame(JHelpDynamicImage.FPS * SampleDynamicAnimation.TIME_ACROSS_SCREEN * 2,
                                       new Position(0, 128));
            ...
            final AnimationFontGif animationFontGif = new AnimationFontGif(0, 98,
