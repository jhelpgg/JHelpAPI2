...
public class JHelpMask
{
    ...
    public void drawCharacter(final char character, final String family)
    {
        ...
        final double factor = Math.min((double) this.width / (double) bounds.width,
                                       (double) this.height / (double) bounds.height);
     ...
     * @param x     Pixel X
     * @param y     Pixel Y
     * @param value {@code true} for light on, {@code false} for light off
     */
