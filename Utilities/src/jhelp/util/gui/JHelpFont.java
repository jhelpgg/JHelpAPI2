        ...
        implements ConstantsGUI
{
     ...
     * @return Created font
     */
    public static JHelpFont createFont(
            final Type type, final InputStream stream, int size, final Value bold,
     ...
     */
    public static JHelpFont obtainFont(
            final Type type, final InputStream stream, final int size, final Value bold,
            final Value italic, final boolean underline)
    {
        try
        {
        ...
        {
            Debug.exception(exception, "Failed to create the font");
            return null;
        }
    }
     ...
     */
    public JHelpFont(
            final String family, final int size, final boolean bold, final boolean italic,
    ...
    public Pair<List<JHelpTextLineAlpha>, Dimension> computeTextLinesAlpha(
            final String text,
     ...
     */
    public Pair<List<JHelpTextLineAlpha>, Dimension> computeTextLinesAlpha(
            final String text, final JHelpTextAlign
            ...
            final int limitHeight, final boolean trim)
    {
        ...
        final ArrayList<JHelpTextLineAlpha> textLines = new ArrayList<>();
        ...
        return new Pair<>(Collections.unmodifiableList(textLines), size);
    }
     ...
     */
    public Pair<List<JHelpTextLineAlpha>, Dimension> computeTextLinesAlphaVertical(
            final String text,
            final int limitHeight)
    {
        ...
        return new Pair<>(textLines, size);
    }
