        ...
        extends Alphabet
{
     ...
     *
     * @param characterWidth  Character with
     * @param characterHeight Character height
     * @param caseSensitive   Indicates if have low and up case characters ({@code true}) OR only up case characters ({@code false})
     */
     ...
     */
    protected abstract @NotNull char[] charactersOrder();
     ...
     */
    @Override
    protected final @Nullable JHelpImage createImageFor(final char character)
    {
     ...
     */
    protected abstract @NotNull String resourcePath();
