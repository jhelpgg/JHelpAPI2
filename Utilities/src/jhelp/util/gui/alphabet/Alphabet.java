...
public abstract class Alphabet
{
     ...
     * @param caseSensitive   Indicates if alphabet case sensitive
     */
    public Alphabet(final int characterWidth, final int characterHeight, final boolean caseSensitive)
    {
        if (characterWidth <= 0)
        {
            throw new IllegalArgumentException("characterWidth MUST be >=1, not " + characterWidth);
        }

        if (characterHeight <= 0)
        {
            throw new IllegalArgumentException("characterHeight MUST be >=1, not " + characterWidth);
        }
     ...
     */
    private void drawOn(
            final @NotNull List<JHelpImage[]> lines, final int x, final int y, final int width, final int height,
            final @NotNull JHelpTextAlign textAlign,
            final @NotNull JHelpImage image, final boolean center)
    {
        int xx = x;
        int yy = y;
     ...
     */
    protected abstract @Nullable JHelpImage createImageFor(char character);
     ...
     */
    public final @NotNull Dimension computeTextDimension(final @NotNull String text)
    {
    ...
    public final void drawOn(
            final @NotNull String text, final @NotNull JHelpTextAlign textAlign, final @NotNull JHelpImage image,
     ...
     * @param x         X coordinate in image
     * @param y         Y coordinate in image
     * @param center    Indicates if given (x, y) is the center of text ({@code true}) OR the up-left corner ({@code false})
     */
    public final void drawOn(
            final @NotNull String text, final @NotNull JHelpTextAlign textAlign, final @NotNull JHelpImage image,
            final int x, final int y, final boolean center)
    {
        final List<JHelpImage[]> lines        = new ArrayList<>();
        final StringCutter       stringCutter = new StringCutter(text, '\n');
        int                      width        = 0;
        int                      height       = 0;
        JHelpImage[]             images;
     ...
     * @return Offset end
     */
    public final int drawOnLimited(
            int offset, final @NotNull String text, final @NotNull JHelpTextAlign textAlign,
            final @NotNull JHelpImage image, final int x, final int y, final boolean center, final int limitWidth,
     ...
     */
    public final int drawOnLimited(
            final int offset, final String text, final @NotNull JHelpTextAlign textAlign,
            final @NotNull JHelpImage image, final int x, final int y, final int limitWidth, final int limitHeight)
    {
    ...
    public final int drawOnLimited(
            final @NotNull String text, final @NotNull JHelpTextAlign textAlign, final @NotNull JHelpImage image,
            final int x, final int y, final boolean center, final int limitWidth, final int limitHeight)
    {
    ...
    public final int drawOnLimited(
            final @NotNull String text, final @NotNull JHelpTextAlign textAlign, final @NotNull JHelpImage image,
            final int x, final int y, final int limitWidth, final int limitHeight)
    {
     ...
     */
    public final @NotNull Dimension getCharacterDimension()
    {
     ...
     */
    public final @NotNull JHelpImage getImageFor(char character)
    {
        if (character <= 32)
        {
     ...
     */
    public final @NotNull JHelpImage[] getImagesFor(final String text)
    {
