 ...
 * @author JHelp
 */
public final class AlphabetText
{
    /**
     * Border size
     */
     ...
     */
    public static @NotNull Dimension obtainNumberColumnsLines(
            final @NotNull Alphabet alphabet, final int width, final int height)
    {
     ...
     * @param numberCharacterPerLine Number of character per line
     * @param numberLine             Number of lines
    ...
    private AlphabetText(
            ...
            final int borderColor, final int backgroundColor, final JHelpImage backgroundImage,
            final @NotNull JHelpPaint backgroundPaint)
    {
        ...
        final RoundRectangle2D roundRectangle2D = new RoundRectangle2D.Double(AlphabetText.BORDER_SIZE_HALF,
                                                                              AlphabetText.BORDER_SIZE_HALF,
                                                                              this.width - AlphabetText.BORDER_SIZE,
                                                                              this.height - AlphabetText.BORDER_SIZE,
                                                                              AlphabetText.BORDER_SIZE,
                                                                              AlphabetText.BORDER_SIZE);
    ...
    public AlphabetText(
            ...
            final @NotNull String text,
            final @NotNull JHelpTextAlign textAlign,
            final int borderColor, final @NotNull JHelpImage backgroundImage)
    {
    ...
    public AlphabetText(
            ...
            final @NotNull String text,
            final @NotNull JHelpTextAlign textAlign,
            final int borderColor, final @NotNull JHelpPaint backgroundPaint)
    {
    ...
    private void updateText()
    {
        synchronized (this.image)
        {
            ...
            if (this.hasPrevious())
            {
                UtilImage.drawIncrustedUpTriangle(this.image.getWidth() - AlphabetText.BORDER_SIZE_TWICE,
            ...
            if (this.hasNext())
            {
                UtilImage.drawIncrustedDownTriangle(this.image.getWidth() - AlphabetText.BORDER_SIZE_TWICE,
                                                    this.image.getHeight() - AlphabetText.BORDER_SIZE_TWICE,
