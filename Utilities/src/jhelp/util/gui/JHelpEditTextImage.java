        ...
        extends JHelpImage
{
     ...
     *
     * @param font Font to use in edit text
     * @param size Number of letter in edit text
     ...
     */
    public static JHelpEditTextImage createEditTextImage(
            final JHelpFont font, final int size, final int color,
     ...
     * @param font        Font to use
     * @param size        Number of letter in edit text
     * @param texture     Texture use for text
     * @param colorCursor Cursor cursor
     * @return Created edit text image
     */
    public static JHelpEditTextImage createEditTextImage(
            final JHelpFont font, final int size, final JHelpImage texture,
            final int colorCursor)
    {
        if (font == null)
        {
     ...
     * @param font        Font to use
     * @param size        Number of letter in edit text
     * @param paint       Paint to use for fill the text
     * @param colorCursor Cursor color
     * @return Created edit text
     */
    public static JHelpEditTextImage createEditTextImage(
            final JHelpFont font, final int size, final JHelpPaint paint,
            final int colorCursor)
    {
        if (font == null)
        {
     ...
     * @param font         Font to use
     * @param color        Text color (used if texture is {@code null} and paint is {@code null})
     * @param texture      Text texture (used if not {@code null} and paint is {@code null})
     * @param paint        Text paint (used if not {@code null})
     * @param colorCursor  Cursor color
     * @param cursorWitdh  Cursor width
     * @param cursorHeight Cursor height
     */
    private JHelpEditTextImage(
            final int width, final int height, final JHelpFont font, final int color,
     ...
     * {@link #update()})
     *
     * @param backgroundPaint New background paint
     */
     ...
     * @param cursor Cursor position or -1 to hide the cursor
     */
