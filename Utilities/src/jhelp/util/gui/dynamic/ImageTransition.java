        ...
        implements DynamicAnimation
{
     ...
     *
     * @param numberTransitionFrame Number of frame for one transition
    ...
    public ImageTransition(
            final int numberTransitionFrame, final JHelpImage from, final JHelpImage to,
     ...
     * {@inheritDoc}
     *
     * @param startAbsoluteFrame Start absolute path
     * @param image              Image parent
