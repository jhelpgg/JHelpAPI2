        ...
        implements DynamicAnimation, Positionable
{
     ...
     * @param x                  Start X
     * @param y                  Start Y
     * @param flagImage          Image to animate
     * @param numberOfWave       Number of waves
     * @param amplitude          Wave sizes
     * @param numberFrameForLoop Number of frame for a complete loop
     */
    public FlagAnimation(
            final int x, final int y, final JHelpImage flagImage, final int numberOfWave, final int amplitude,
    ...
    {
        this.angle = Math2.modulo(((absoluteFrame - this.startAbsoluteFrame) * 2 * Math.PI) / this.numberFrameForLoop,
                                  Math.PI * 2);
        this.refreshSprite();
        return true;
    }
