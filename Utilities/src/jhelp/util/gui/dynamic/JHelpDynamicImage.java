...
public class JHelpDynamicImage
{
        ...
        while (this.alive.get())
        {
            ...
            synchronized (this.lock)
            {
                ...
                for (index = size - 1; index >= 0; index--)
                {
                    ...
                    if (!animation.first.animate(this.getAbsoluteFrame(), this.image))
                    {
     ...
     *
     * @param dynamicAnimation Animation to play
     * @param listener         Listener to call back when given animation finished. {@code null} means no listener
     */
    ...
    public void stopAnimation(final DynamicAnimation dynamicAnimation)
    {
        synchronized (this.lock)
        {
            ...
            {
                if (pair.first.equals(dynamicAnimation))
                {
                    animation = pair;
                    break;
                }
