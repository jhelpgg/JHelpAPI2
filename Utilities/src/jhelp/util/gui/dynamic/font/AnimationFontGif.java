 ...
 * @author JHelp
 */
public final class AnimationFontGif
        implements DynamicAnimation, Positionable
{
     ...
     */
    public AnimationFontGif(final int x, final int y, final @NotNull String text, final @NotNull FontGif fontGif)
    {
        this.x = x;
        this.y = y;
     ...
     */
    @Override
    public boolean animate(final float absoluteFrame, final @NotNull JHelpImage image)
    {
        if (this.sprite == null)
        {
            return false;
        ...
        for (final GifPosition gifPosition : this.gifText.gifPositions())
        {
            gif = gifPosition.gif();
            spriteImage.drawImage(gifPosition.x(), gifPosition.y(),
                                  gif.getImage(
                                          (int) ((absoluteFrame - this.startAbsoluteFrame) / 4f) %
                                          gif.numberOfImage()));
        }
     ...
     */
    @Override
    public void endAnimation(final @NotNull JHelpImage image)
    {
        if (this.sprite != null)
        {
     ...
     */
    @Override
    public void startAnimation(final float startAbsoluteFrame, final @NotNull JHelpImage image)
    {
        ...
        {
            gif = gifPosition.gif();
            spriteImage.drawImage(gifPosition.x(), gifPosition.y(), gif.getImage(0));
        }
     ...
     * @see jhelp.util.gui.dynamic.Positionable#position()
     */
    @Override
     ...
     * @see jhelp.util.gui.dynamic.Positionable#position(jhelp.util.gui.dynamic.Position)
     */
    @Override
