...
/**
 * Binary solver model for draw a binary solver
 *
 * @param <ELEMENT> Tree element type
 * @author JHelp
 */
public class BinaryTreeModel<ELEMENT>
{
     ...
     *
     * @param elementClass                   Element in solver class type
     * @param comparator                     Comparator to sort elements in solver
     * @param binaryTreeModelElementRenderer Describes how draw solver elements
     * @param linesColor                     Lines color
     * @param background                     Background color
     */
    public BinaryTreeModel(
            final Class<ELEMENT> elementClass, final Comparator<ELEMENT> comparator,
            final BinaryTreeModelElementRenderer<ELEMENT> binaryTreeModelElementRenderer, final int linesColor,
            final int background)
    {
        ...
        this.binaryTree = new BinaryTree<>(elementClass, this.comparator);
    ...
    /**
     * Compute size of a image solver (Tree contains pre-computed images)
     *
    ...
    private void createImage()
    {
        ...
        // Create solver of images
        final BinaryTree<ELEMENT>.Branch<ELEMENT> branch = this.binaryTree.getTrunk();
        final Tree<JHelpImage> tree = new Tree<>(
                this.binaryTreeModelElementRenderer.obtainBinaryTreeModelElementImage(this, branch.getElement()));
    ...
    /**
     * Draw a solver branch inside image defined area
     *
     * @param tree Tree branch to draw
     * @param x    X coordinate where draw
    ...
    /**
     * Insert a binary branch inside a solver image branch
     *
     * @param branch Binary branch to insert
     * @param tree   Tree image where insert
     */
    private void insertInTree(final BinaryTree<ELEMENT>.Branch<ELEMENT> branch, final Tree<JHelpImage> tree)
    {
        ...
        if (subBranch != null)
        {
            final Tree<JHelpImage> subTree = tree.addBranch(
                    this.binaryTreeModelElementRenderer.obtainBinaryTreeModelElementImage(this,
                                                                                          subBranch.getElement()));
