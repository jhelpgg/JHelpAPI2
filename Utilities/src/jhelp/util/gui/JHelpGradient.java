        ...
        implements JHelpPaint
{
    ...
    {
        return (this.alphaDownRight << 24) | (this.redDownRight << 16) | (this.greenDownRight << 8) |
               this.blueDownRight;
    }
    ...
    public int obtainColor(final int x, final int y)
    {
        ...
        return ((((((this.alphaUpLeft * xx) + (this.alphaUpRight * x)) * yy) +
                  (((this.alphaDownLeft * xx) + (this.alphaDownRight * x)) * y)) / this.size) << 24)
               | //
               ((((((this.redUpLeft * xx) + (this.redUpRight * x)) * yy) +
                  (((this.redDownLeft * xx) + (this.redDownRight * x)) * y)) / this.size) << 16) | //
               ((((((this.greenUpLeft * xx) + (this.greenUpRight * x)) * yy) +
                  (((this.greenDownLeft * xx) + (this.greenDownRight * x)) * y)) / this.size) << 8) | //
