...
public class JHelpTextLineAlpha
{
     ...
     *
     * @param text      Text to carry
     * @param x         X position
     * @param y         Y position
     * @param width     Part width
     * @param height    Part height
     * @param mask      Mask to use
     * @param endOfLine Indicates if the part is a end of line
     */
    public JHelpTextLineAlpha(
            final String text, final int x, final int y, final int width, final int height, final JHelpImage mask,
            final boolean endOfLine)
    {
        this.text = text;
        this.x = x;
        this.y = y;
