 ...
 * (2*625+2). For a better understanding try SampleTribal (Type numbers and then enter to see tribal representation)
 *
 * @author JHelp
 */
public class TribalNumber
{
    ...
    public static TribalNumber parse(final char... characters)
    {
        ...
        for (final char character : characters)
        {
            switch (character)
            {
                case TribalNumber.DIGIT_0:
                case TribalNumber.DIGIT_1:
                case TribalNumber.DIGIT_2:
                case TribalNumber.DIGIT_3:
                case TribalNumber.DIGIT_4:
                case TribalNumber.DIGIT_5:
                    number += character - TribalNumber.DIGIT_0;
                    break;
                case TribalNumber.GROUP_25:
                    number += 25;
                    break;
                case TribalNumber.GROUP_125:
                    number += 125;
                    break;
                case TribalNumber.GROUP_625:
                    if (number == 0)
                    {
                        number = 625;
                    }
