        ...
        extends BinaryOperator
{
            ...
            implements FunctionSimplifier
    {
        ...
        {
            return new Percent(
                    new Division(new Multiplication(percent1.parameter, percent2.parameter), Constant.HUNDRED));
        }
    ...
    public Function derive(final Variable variable)
    {
        ...
        return Function.createAddition(Function.createMultiplication(d1, this.parameter2),
    ...
    {
        return Function.createMultiplication(this.parameter1.replace(variable, function),
