        ...
        extends BinaryOperator
{
            ...
            implements FunctionSimplifier
    {
        ...
        private Function simplify(final Function function1, final Function function2)
        {
            ...
            if ((additions1.length > 1) || (additions2.length > 1))
            {
                ...
                return new Subtraction(f.simplify(),
                                       Function.createAddition(Arrays.copyOfRange(additions2, o, m)).simplify());
            }
        ...
        {
            if ((function.equals(multiplication.parameter1) == true) &&
                ((multiplication.parameter2 instanceof Constant) == true))
            {
            ...
            if ((function.equals(multiplication.parameter2) == true) &&
                ((multiplication.parameter1 instanceof Constant) == true))
            {
         ...
         * @param percent2  Precent argument P
         * @return Simplification
         */
        ...
        private Function simplify(final Multiplication multiplication1, final Multiplication multiplication2)
        {
            ...
            {
                if (((multiplication1.parameter2 instanceof Cosinus) == true) &&
                    ((multiplication2.parameter1 instanceof Sinus) == true) &&
                    ((multiplication2.parameter2 instanceof Sinus) == true))
                {
                ...
                if (((multiplication1.parameter2 instanceof Sinus) == true) &&
                    ((multiplication2.parameter1 instanceof Cosinus) == true) &&
                    ((multiplication2.parameter2 instanceof Sinus) == true))
                {
                    return this.simplifySubtractionOfMultiplications((Cosinus) multiplication1.parameter1,
                ...
                if (((multiplication1.parameter2 instanceof Sinus) == true) &&
                    ((multiplication2.parameter1 instanceof Sinus) == true) &&
                    ((multiplication2.parameter2 instanceof Cosinus) == true))
                {
                    return this.simplifySubtractionOfMultiplications((Cosinus) multiplication1.parameter1,
                                                                     (Sinus) multiplication1.parameter2,
                                                                     (Sinus) multiplication2.parameter1,
         ...
         *
         * @param percent1 Precent P1 argument
         ...
         * @return Simplification
         */
        private Function simplifySubtractionOfMultiplications(
                final Constant constant1, final Function function1, final Constant constant2, final Function function2)
        {
            if ((constant1.isUndefined() == true) || (constant2.isUndefined() == true))
            {
                return Constant.UNDEFINED;
         ...
         */
        private Function simplifySubtractionOfMultiplications(
                final Constant constant1, final Function function1, final Function function2, final Constant constant2)
        {
            if ((constant1.isUndefined() == true) || (constant2.isUndefined() == true))
            {
                return Constant.UNDEFINED;
                ...
                final Cosinus cosinus1, final Cosinus cosinus2, final Sinus sinus1, final Sinus sinus2)
        {
            ...
            {
                return new Cosinus(
                        Function.createAddition(cosinus1.parameter.simplify(), cosinus2.parameter.simplify()));
            }
         ...
         */
        private Function simplifySubtractionOfMultiplications(
                final Function function1, final Constant constant1, final Constant constant2, final Function function2)
        {
            if ((constant1.isUndefined() == true) || (constant2.isUndefined() == true))
            {
                return Constant.UNDEFINED;
         ...
         */
        private Function simplifySubtractionOfMultiplications(
                final Function function1, final Constant constant1, final Function function2, final Constant constant2)
        {
            if ((constant1.isUndefined() == true) || (constant2.isUndefined() == true))
            {
                return Constant.UNDEFINED;
                ...
                final Sinus sinus1, final Sinus sinus2, final Cosinus cosinus1, final Cosinus cosinus2)
        {
            if (((cosinus1.parameter.equals(sinus1.parameter) == true) &&
                ...
                || ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
                    (cosinus2.parameter.equals(sinus1.parameter) == true)))
            {
                return new MinusUnary(new Cosinus(
                        Function.createAddition(cosinus1.parameter.simplify(), cosinus2.parameter.simplify())));
            }
    ...
    {
        return new Subtraction(this.parameter1.replace(variable, function),
