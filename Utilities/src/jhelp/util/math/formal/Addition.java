        ...
        extends BinaryOperator
{
            ...
            implements FunctionSimplifier
    {
        ...
        private Function simplify(final Addition addition, final Function function)
        {
            ...
            return new Addition(addition.getParameter2().simplify(),
                                new Addition(addition.getParameter1().simplify(), function.simplify()));
        }
        ...
        private Function simplify(final Logarithm logarithm1, final Logarithm logarithm2)
        {
            ...
            return new Logarithm(Function.createMultiplication(logarithm1.getParameter().simplify(),
                                                               logarithm2.getParameter().simplify()));
        }
        ...
        private Function simplify(final MinusUnary minusUnary1, final MinusUnary minusUnary2)
        {
            ...
            return new MinusUnary(
                    new Addition(minusUnary1.getParameter().simplify(), minusUnary2.getParameter().simplify()));
        }
        ...
        private Function simplify(final Multiplication multiplication1, final Multiplication multiplication2)
        {
            ...
            {
                if (((function2 instanceof Cosinus) == true) && ((function3 instanceof Sinus) == true) &&
                    ((function4 instanceof Sinus) == true))
                {
                    return this.simplifyAdditionOfMultiplcations((Cosinus) function1, (Cosinus) function2,
                                                                 (Sinus) function3, (Sinus) function4);
                }

                if (((function2 instanceof Sinus) == true) && ((function3 instanceof Cosinus) == true) &&
                    ((function4 instanceof Sinus) == true))
                {
                    return this.simplifyAdditionOfMultiplcations((Cosinus) function1, (Sinus) function2,
                                                                 (Cosinus) function3, (Sinus) function4);
                }

                if (((function2 instanceof Sinus) == true) && ((function3 instanceof Sinus) == true) &&
                    ((function4 instanceof Cosinus) == true))
                {
                    return this.simplifyAdditionOfMultiplcations((Cosinus) function1, (Sinus) function2,
            ...
            if ((function1 instanceof Sinus) == true)
            {
                if (((function2 instanceof Cosinus) == true) && ((function3 instanceof Sinus) == true) &&
                    ((function4 instanceof Cosinus) == true))
                {
                    return this.simplifyAdditionOfMultiplcations((Sinus) function1, (Cosinus) function2,
                                                                 (Sinus) function3, (Cosinus) function4);
                }

                if (((function2 instanceof Cosinus) == true) && ((function3 instanceof Cosinus) == true) &&
                    ((function4 instanceof Sinus) == true))
                {
                    return this.simplifyAdditionOfMultiplcations((Sinus) function1, (Cosinus) function2,
                                                                 (Cosinus) function3, (Sinus) function4);
                ...
                if (((function2 instanceof Sinus) == true) && ((function3 instanceof Cosinus) == true) &&
                    ((function4 instanceof Cosinus) == true))
                {
                    return this.simplifyAdditionOfMultiplcations((Sinus) function1, (Sinus) function2,
        ...
        {
            return Function.createAddition(function2,
                                           new Division(Function.createMultiplication(percent1.parameter, function2),
                                                        Constant.HUNDRED));
        }
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplcations(
                final Cosinus cosinus1, final Cosinus cosinus2, final Sinus sinus1, final Sinus sinus2)
        {
            if (((cosinus1.parameter.equals(sinus1.parameter) == true) &&
                 (cosinus2.parameter.equals(sinus2.parameter) == true))
                || ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
                    (cosinus2.parameter.equals(sinus1.parameter) == true)))
            {
         ...
         */
        private Function simplifyAdditionOfMultiplcations(
                final Cosinus cosinus1, final Sinus sinus1, final Cosinus cosinus2, final Sinus sinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
                (sinus1.parameter.equals(cosinus2.parameter) == true))
            {
         ...
         */
        private Function simplifyAdditionOfMultiplcations(
                final Cosinus cosinus1, final Sinus sinus1, final Sinus sinus2, final Cosinus cosinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
                (sinus1.parameter.equals(cosinus2.parameter) == true))
            {
         ...
         */
        private Function simplifyAdditionOfMultiplcations(
                final Function function1, final Function function2, final Function function3, final Function function4)
        {
            if (function1.equals(function3) == true)
            {
                return Function.createMultiplication(
                        Function.createAddition(function2.simplify(), function4.simplify()), function1.simplify());
            }

            if (function1.equals(function4) == true)
            {
                return Function.createMultiplication(
                        Function.createAddition(function2.simplify(), function3.simplify()), function1.simplify());
            }

            if (function2.equals(function3) == true)
            {
                return Function.createMultiplication(
                        Function.createAddition(function1.simplify(), function4.simplify()), function2.simplify());
            }

            if (function2.equals(function4) == true)
            {
                return Function.createMultiplication(
                        Function.createAddition(function1.simplify(), function3.simplify()), function2.simplify());
            }
         ...
         */
        private Function simplifyAdditionOfMultiplcations(
                final Sinus sinus1, final Cosinus cosinus1, final Cosinus cosinus2, final Sinus sinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
                (sinus1.parameter.equals(cosinus2.parameter) == true))
            {
         ...
         */
        private Function simplifyAdditionOfMultiplcations(
                final Sinus sinus1, final Cosinus cosinus1, final Sinus sinus2, final Cosinus cosinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
                (sinus1.parameter.equals(cosinus2.parameter) == true))
            {
         ...
         */
        private Function simplifyAdditionOfMultiplcations(
                final Sinus sinus1, final Sinus sinus2, final Cosinus cosinus1, final Cosinus cosinus2)
        {
            if (((cosinus1.parameter.equals(sinus1.parameter) == true) &&
                 (cosinus2.parameter.equals(sinus2.parameter) == true))
                || ((cosinus1.parameter.equals(sinus2.parameter) == true) &&
         ...
         * @return Simplified function
         */
        private Function simplifyAdditonOfMultiplicationAndFunction(
                final Function parameter1, final Function parameter2, final Function function)
        {
