        ...
        implements ConstantsReferences
{
    ...
    public static ConstantsReferences getReferentielConstanteCourant()
    {
        ...
        {
            rcd.defineConstant(ConstantsReferencesDefault.SYMBOLS_NAMES[i],
                               ConstantsReferencesDefault.SYMBOLS_VALUES[i]);
        }
        return rcd;
    }
     ...
     * Define a constant
     *
     * @param nom    Constant name
     * @param valeur Constant value
