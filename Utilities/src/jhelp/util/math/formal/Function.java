        ...
        implements Comparable<Function>
{
    ...
    public static final boolean allEquals(final Function function, final Function... functions)
    {
        if (function == null)
        {
            throw new NullPointerException("function mustn't be null");
        }

        if (functions == null)
        {
            throw new NullPointerException("functions mustn't be null");
        }
    ...
    public static Function createMultiplication(final Function function, final int time)
    {
        ...
        switch (time)
        {
            ...
            case 4:
                return new Multiplication(new Multiplication(function, function),
                                          new Multiplication(function, function));
            default:
    ...
    public int compareTo(final Function function)
    {
        ...
        if (((function instanceof Constant) == true) || ((function instanceof Variable) == true) ||
            ((function instanceof MinusUnary) == true))
        {
            return 1;
        }
