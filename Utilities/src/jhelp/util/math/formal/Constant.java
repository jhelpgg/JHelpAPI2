        ...
        extends Function
{
    ...
    protected int compareToInternal(final Function function)
    {
        ...
        if (Math2.equals(this.real, constant.real) == true)
        {
            return 0;
        }
    ...
    public String toString()
    {
        ...
        // Keep the sign
        final int    sign = Math2.sign(this.real);
    ...
    public boolean functionIsEquals(final Function function)
    {
        ...
        if (function instanceof Constant)
        {
            ...
            return Math2.equals(this.real, constant.real);
        }
    ...
    {
        return Math2.equals(this.real, -1D);
    }
    ...
    {
        return Math2.equals(this.real, 1.0D);
    }
