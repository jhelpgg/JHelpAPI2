        ...
        extends BinaryOperator
{
            ...
            implements FunctionSimplifier
    {
        ...
        private Function simplify(final Exponential exponential1, final Exponential exponential2)
        {
            return new Exponential(
                    new Subtraction(exponential1.parameter.simplify(), exponential2.parameter.simplify()));
        }
         ...
         * @return C3/f
         */
        private Function simplifyDivisionOfConstantMultiplication(
                final Constant constant, final Constant parameterConstant, final Function parameter)
        {
            if ((parameterConstant.isUndefined() == true) || (parameterConstant.isNul() == true) ||
                (constant.isUndefined() == true))
            {
                return Constant.UNDEFINED;
            }

            return new Division(
                    new Constant(constant.obtainRealValueNumber() / parameterConstant.obtainRealValueNumber()),
                    parameter.simplify());
        }
         ...
         */
        private Function simplifyDivisionOfConstantMultiplication(
                final Constant constant, final Function parameter, final Constant parameterConstant)
        {
            if ((parameterConstant.isUndefined() == true) || (parameterConstant.isNul() == true) ||
                (constant.isUndefined() == true))
            {
         ...
         */
        private Function simplifyDivisionOfConstantMultiplication(
                final Constant constant, final Function parameter1, final Function parameter2)
        {
         ...
         * @return C3*f
         */
        private Function simplifyDivisionOfMultiplicationConstant(
                final Constant parameterConstant, final Function parameter, final Constant constant)
        {
            if ((parameterConstant.isUndefined() == true) || (constant.isUndefined() == true) ||
                (constant.isNul() == true))
            {
                return Constant.UNDEFINED;
            }
         ...
         */
        private Function simplifyDivisionOfMultiplicationConstant(
                final Function parameter, final Constant parameterConstant, final Constant constant)
        {
            if ((parameterConstant.isUndefined() == true) || (constant.isUndefined() == true) ||
                (constant.isNul() == true))
            {
         ...
         */
        private Function simplifyDivisionOfMultiplicationConstant(
                final Function parameter1, final Function parameter2, final Constant constant)
        {
    ...
    public boolean functionIsEquals(final Function function)
    {
        ...
        {
            final Division division = (Division) function;
            return this.parameter1.functionIsEquals(division.parameter1) &&
                   this.parameter2.functionIsEquals(division.parameter2);
        }
        else
        {
            return false;
