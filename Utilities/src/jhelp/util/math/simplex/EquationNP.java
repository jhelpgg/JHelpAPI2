...
public class EquationNP
{
     ...
     *
     * @param maximize          Indicates if objective have to be maximize ({@code true}) or minimize ({@code false})
     * @param objectiveEquality Objective equality
    ...
    public ResultEquationNP resolve()
    {
        ...
        return new ResultEquationNP(this.maximize, this.objectiveSymbol, sign * simplexResult.objectiveValue(),
