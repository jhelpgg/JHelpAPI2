...
public class ResultEquationNP
{
     ...
     *
     * @param maximize           Indicates if its a maximum or minimum
     * @param objective          Objective name
     * @param objectiveValue     Objective value
     * @param objectiveCondition Initial objective condition
     * @param parameters         Parameters/variables names
     * @param values             Parameters/variables values
     */
    ResultEquationNP(
            final boolean maximize, final char objective, final double objectiveValue,
            final Condition objectiveCondition, final char[] parameters,
            final double[] values)
    {
