...
public class Base
{
     ...
     *
     * @param baseDigits Digits symbols
     */
     ...
     *
     * @param base                     Base size
     * @param lowerCaseBeforeUpperCase Indicates if just after [0-9] will found lower case ({@code true}) or upper case ({@code false})
     */
    ...
    public long parse(final String string)
    {
        ...
        for (int index = start; index < length; index++)
        {
            ...
            {
                throw new IllegalArgumentException(
                        "Given string have at least one invalid character at " + index + " given string : " + string);
            }
