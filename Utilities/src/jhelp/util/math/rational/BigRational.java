        ...
        implements Comparable<BigRational>
{
     ...
     * -1 rational
     */
    public static final BigRational MINUS_ONE        = new BigRational(Math2.BIG_MINUS_ONE, BigInteger.ONE);
    /**
     * 1 rational
     */
    ...
    {
        return BigRational.createRational(Math2.createBigInteger(integer));
    }
    ...
    {
        return BigRational.createRational(Math2.createBigInteger(numerator), Math2.createBigInteger(denominator));
    }
    ...
    public static BigRational middle(final BigRational rational1, final BigRational rational2)
    {
        ...
        return BigRational.createRational(rational1.numerator.multiply(rational2.denominator)
                                          ...
                                          rational1.denominator.multiply(
                                                  rational2.denominator.multiply(Math2.BIG_TWO)));
    }
    ...
    public BigDecimal value()
    {
        ...
        if (this.denominator.compareTo(BigInteger.ONE) == 0)
        {
            return Math2.bigIntegerToBigDecimal(this.numerator);
        }

        return Math2.bigIntegerToBigDecimal(this.numerator)
                    .divide(Math2.bigIntegerToBigDecimal(this.denominator), BigRational.mathContext());
    }
