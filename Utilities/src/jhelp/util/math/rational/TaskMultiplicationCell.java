        ...
        extends Thread
{
     ...
     *
     * @param count       Number task left (Use for know when all tasks are done)
     * @param x           X of the task cell
     * @param y           Y of the task cell
    ...
    public TaskMultiplicationCell(
            ...
            final int resultWidth, final Rational[] result, final Rational[] first, final Rational[] second)
    {
        this.count = count;
        this.x = x;
        this.y = y;
