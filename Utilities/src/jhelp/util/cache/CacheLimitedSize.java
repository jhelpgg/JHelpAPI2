...
public class CacheLimitedSize<TYPE>
{
     ...
     *
     * @param limitedSizeMap Type of limitation to use
     */
     ...
     *
     * @param key                   Element key
     * @param elementCreatorDefault Creator to use if element not already inside the cache
     ...
     *
     * @param key            Key
     * @param elementCreator Describe how create the element
     */
    public void put(final String key, final CacheElement<TYPE> elementCreator)
    {
        ...
        this.limitedSizeMap.put(key, elementCreator.element());
    }
