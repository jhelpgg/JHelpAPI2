...
public final class UtilText
{
    ...
    public static int computeDistance(
            String text1, String text2, final boolean caseSensitive, final String wordDelimiters)
    {
        if (text1 == null)
        {
    ...
    public static double[] extractDoubleFrom(final String string)
    {
        ...
        {
            pair = pairs.get(i);
            array[i] = Double.parseDouble(string.substring(pair.first, pair.second));
        }
    ...
    public static float[] extractFloatFrom(final String string)
    {
        ...
        {
            pair = pairs.get(i);
            array[i] = Float.parseFloat(string.substring(pair.first, pair.second));
        }
    ...
    public static int[] extractIntFrom(final String string)
    {
        ...
        {
            pair = pairs.get(i);
            array[i] = Integer.parseInt(string.substring(pair.first, pair.second));
        }
    ...
    public static long[] extractLongFrom(final String string)
    {
        ...
        {
            pair = pairs.get(i);
            array[i] = Long.parseLong(string.substring(pair.first, pair.second));
        }
     ...
     */
    public static int indexOfIgnoreStrings(
            final String text, final String search, final int startIndex,
    ...
    public static int parseInteger(final String string)
    {
        ...
        {
            throw new IllegalArgumentException(
                    UtilText.concatenate(
                            "The number in hexadecimal can't be more than 8 characters (after the 0x), so '",
    ...
    public static String resolveImagesLinkInHTML(String html)
    {
        ...
        while (matcher.find())
        {
            ...
            {
                Debug.exception(exception, "Failed to resolve resource class=", className, " path=", path);
