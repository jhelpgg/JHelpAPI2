...
public class JHelpIDL
{
    static
    {
        ...
        final String[] paths =
                {
                        ...
                        System.getProperty("java.home"), UtilIO.obtainOutsideDirectory().getAbsolutePath()
                };
        ...
        Debug.verbose("IDL_DIRECTORY=", JHelpIDL.IDL_DIRECTORY.getAbsolutePath());
    }
    ...
    private static List<NameCode> createClassesForInterface(final Class<?> interfaceIDL)
    {
        ...
        for (final Method method : methods)
        {
            ...
            if ((claz != null) && (claz.isPrimitive() == false) &&
    ...
    public static void declareIDLs(final Class<?>... interfacesIDL) throws IOException
    {
        ...
        {
            JHelpIDL.CLASS_LOADER.add(new File(JHelpIDL.COMPILE_DIRECTORY_BIN,
    ...
    private static boolean needClassAsReadParameter(final Class<?> type)
    {
        ...
        if (Reflection.isInherit(type, String.class) == true)
        {
            return false;
        }

        if (Reflection.isInherit(type, Binarizable.class) == true)
        {
            return true;
        }
    ...
    public static <TYPE> TYPE obtainSenderInstance(final Class<TYPE> interfaceIDL) throws ClassNotFoundException
    {
        ...
        if (sender == null)
        {
            sender = (TYPE) Reflection.newInstance(className, JHelpIDL.CLASS_LOADER);
     ...
     * @throws IllegalAccessException    If the interface targetted is protected by security form refelection
     * @throws IllegalArgumentException  If the implementation given is wrong type
     * @throws InvocationTargetException If the interface targetted is protected by security form refelection or registeration had previously issue
     */
    @SuppressWarnings("unchecked")
                   ...
                   IllegalArgumentException, InvocationTargetException
    {
        ...
        {
            throw new NullPointerException("interfaceIDLImplementation mustn't be null");
        }
