...
public class HttpCommunication
{
     ...
     *
     * @param urlPath          Connection URL
     * @param method           Request method
     * @param responseReceiver Listener of server response
     */
    ...
    void doAnswers()
    {
        ...
        {
            Debug.exception(exception, "Failed to get message from ", this.urlPath);
        }
        finally
        {
            try
    ...
    void doErrors()
    {
        ...
        {
            Debug.exception(exception, "Failed to report error for ", this.urlPath);
        }
        finally
        {
            try
    ...
    public void connect()
    {
        ...
        try
        {
            ...
            final byte[] bodyEnd = UtilText.concatenate(separator, boundaryMark, "CAFEFACE", boundaryMark, separator)
                                           .getBytes();
