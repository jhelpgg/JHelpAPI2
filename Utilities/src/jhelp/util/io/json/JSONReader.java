        ...
        for (String key : objectJSON.getKeys())
        {
            try
            {
                ...
                else if (double.class.equals(fieldClass))
                {
                    ...
                    {
                        //FIXME : Decide if have to do something for null type
                    ...
                    else
                    {
                        ...
                        switch (valueJSON.getType())
                        {
                            ...
                            case OBJECT:
                            default:
                                instance = Reflection.newInstance(fieldClass);
                                JSONReader.fillObject(fieldClass, instance, objectJSON.getObject(key), strict);
                                break;
                        }
