...
public class ByteArray
{
    ...
    public int read(final byte[] b, final int off, int len)
    {
        ...
        len = Math2.minimum(len, b.length - off, this.size - this.index);
    ...
    public <B extends Binarizable> B[] readBinarizableArray(final Class<B> clas) throws Exception
    {
        ...
        @SuppressWarnings("unchecked") final B[] array = (B[]) Array.newInstance(clas, length);
    ...
    public <B extends Binarizable> B readBinarizable(final Class<B> clas) throws Exception
    {
        ...
        @SuppressWarnings("unchecked") final B binarizable = (B) Reflection.newInstance(clas);
    ...
    public <E extends Enum> E[] readEnumArray(final Class<E> clas) throws Exception
    {
        ...
        @SuppressWarnings("unchecked") final E[] array = (E[]) Array.newInstance(clas, length);
    ...
    public <B extends Binarizable> B readBinarizableNamed() throws Exception
    {
        ...
        final String                           name        = this.readString();
        @SuppressWarnings("unchecked") final B binarizable = (B) Reflection.newInstance(name);
