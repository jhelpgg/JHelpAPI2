        ...
        extends PipeCommons
{
     ...
     *
     * @param pipeDirectory Pipe directory where read messages
     */
    public PipeReader(final File pipeDirectory)
    {
        if (pipeDirectory == null)
        {
            throw new NullPointerException("pipeDirectory mustn't be null");
        }
     ...
     * @throws PipeException On problem on reading next message
     */
     ...
     * @param binarizableClass Binarizable calss to read
     * @return Read binarizable
     * @throws PipeException If reader is stopped or the message can't be cast to the desired binarizable
     */
