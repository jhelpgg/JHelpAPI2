        ...
        extends InputStream
{
    ...
    public int read() throws IOException
    {
        ...
        switch (this.step)
        {
            ...
            case Base64InputStream.STEP_3:
                ...
                return actual | (index & 0x3F);
            case Base64InputStream.STEP_END:
                return -1;
        }
     ...
     * {@inheritDoc}
     *
     * @throws IOException If mark not supported
