        ...
        extends OutputStream
{
    ...
    public void write(final int b) throws IOException
    {
        switch (this.step)
        {
            case Base64OutputStream.STEP_1:
                this.outputStream.write(Base64Common.getSymbol((b >> 2) & 0x3F));

                this.previous = b & 0x03;

                this.step = Base64OutputStream.STEP_2;
                break;
            case Base64OutputStream.STEP_2:
                ...
                break;
            case Base64OutputStream.STEP_3:
                this.outputStream.write(Base64Common.getSymbol((this.previous << 2) | ((b >> 6) & 0x03)));

                this.outputStream.write(Base64Common.getSymbol(b & 0x3F));
    ...
    public void close() throws IOException
    {
        ...
        try
        {
            switch (this.step)
            {
                case Base64OutputStream.STEP_1:
                    break;
                case Base64OutputStream.STEP_2:
                    this.outputStream.write(Base64Common.getSymbol(this.previous << 4));
                    this.outputStream.write(Base64Common.COMPLEMENT);
                    this.outputStream.write(Base64Common.COMPLEMENT);
                    this.outputStream.write(Base64Common.COMPLEMENT);
                    break;
                case Base64OutputStream.STEP_3:
                    this.outputStream.write(Base64Common.getSymbol(this.previous << 2));
                    this.outputStream.write(Base64Common.COMPLEMENT);
                    this.outputStream.write(Base64Common.COMPLEMENT);
                    break;
            }
        ...
        catch (final IOException exception)
        {
            ...
            else
            {
                ...
                {
                    Debug.exception(ioException, "This exception is consumed");
