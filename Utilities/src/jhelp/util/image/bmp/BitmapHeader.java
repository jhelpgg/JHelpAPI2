...
public class BitmapHeader
{
    ...
    public static int read4bytes(final InputStream inputStream) throws IOException
    {
        ...
        return ((BitmapHeader.BUFFER_4[3] & 0xFF) << 24) | ((BitmapHeader.BUFFER_4[2] & 0xFF) << 16) |
               ((BitmapHeader.BUFFER_4[1] & 0xFF) << 8)
     ...
     * @param jumpHeader  {@code true} for nor read first part of header. {@code false} for full read
     * @throws IOException On reading issue
     */
