        ...
        implements DynamicAnimation
{
            ...
            throws IOException
    {
        ...
        Debug.information("this.images.size()=", this.images.size());
        Debug.information("this.totalFrame=", this.totalFrame);
    }
    ...
    private void parseAniHeader(final RiffChunk chunk) throws IOException
    {
        ...
        Debug.information("this.numberOfFrames=", this.numberOfFrames);
        Debug.information("this.bitCount=", this.bitCount);
        ...
        Debug.information("this.rowData=", this.rowData);
        Debug.information("this.numberOfFrames=", this.numberOfFrames);
    }
    ...
    private void parseIcon(final RiffChunk chunk) throws IOException
    {
        ...
        {
            case 2:
                this.images.add(new AniImageInformation(
                        new IcoImage(chunk.dataAsStream(), RasterImageType.getRasterImageType(this.bitCount))));
                break;
            case 1:
