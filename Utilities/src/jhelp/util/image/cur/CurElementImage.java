...
public class CurElementImage
{
     ...
     *
     * @param inputStream Stream where read cursor element image
     ...
     *
     * @param parent Image where draw the cursor element
     * @param x      X on image where place the up-left cursor corner
     * @param y      Y on image where place the up-left cursor corner
     */
