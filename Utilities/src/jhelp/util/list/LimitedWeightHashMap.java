        ...
        extends HeavyObject
{
     ...
     */
    boolean put(final KEY key, final HeavyObjectCreator<VALUE> creator);
     ...
     */
    Result put(final KEY key, final HeavyObjectCreator<VALUE> creator, final boolean allowAutomaticRemove);
     ...
     * @throws IllegalArgumentException If the element weight is bigger than map maximum weight
     */
    boolean put(final KEY key, final VALUE value);
     ...
     * @return The result operation
     */
    Result put(final KEY key, final VALUE value, final boolean allowAutomaticRemove);
