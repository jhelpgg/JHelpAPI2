 ...
 */
public final class EnumerationIteratorLong
        implements Iterable<Long>, Enumeration<Long>, Iterator<Long>, PrimitiveIterator.OfLong,
                   Spliterator.OfLong
{
    /**
     * Embed enumeration
     */
    private final Enumeration<Long> enumeration;
    /**
     * Embed iterator
     */
     ...
     */
    public EnumerationIteratorLong(@NotNull Enumeration<Long> enumeration)
    {
     ...
     */
    public EnumerationIteratorLong(@NotNull Iterator<Long> iterator)
    {
        this(iterator, true);
    }
     ...
     */
    public EnumerationIteratorLong(@NotNull Iterator<Long> iterator, boolean removeAllowed)
    {
     ...
     */
    public EnumerationIteratorLong(@NotNull long[] array)
    {
    ...
    {
        ForEach.forEach((Iterable<Long>) this, action::accept);
    }
    ...
    public @Nullable Long next()
    {
        ...
        long value = this.array[this.index];
        this.index++;
        return value;
    }
     ...
     *
     * @param action
     * @implSpec If the action is an instance of {@code LongConsumer} then it is
     * cast to {@code LongConsumer} and passed to
     * {@link #forEachRemaining}; otherwise the action is adapted to
     * an instance of {@code LongConsumer}, by boxing the argument of
     ...
     */
    @Override
    public @Nullable Long nextElement()
    {
        return this.next();
    }
    ...
    public boolean tryAdvance(final LongConsumer action)
    {
        if (this.hasNext())
        {
            ThreadManager.parallel(action::accept, this.nextLong());
            return true;
        }
