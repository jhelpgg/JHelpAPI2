 ...
 * @author JHelp
 */
public final class DynamicWriteXML
{
    /**
     * End of comment
     */
     ...
     * @throws IOException On writing header issue
     */
    public DynamicWriteXML(
            final OutputStream outputStream, final boolean compact, final boolean textSameLine,
    ...
    public boolean closeMarkup() throws IOException
    {
        switch (this.status)
        {
            case DynamicWriteXML.STATUS_TERMINATE:
                throw new IllegalStateException("The writing can't continue");
            case DynamicWriteXML.STATUS_HAVE_TO_OPEN_MARKUP:
                throw new IllegalStateException("Have to start by open a markup");
            case DynamicWriteXML.STATUS_MARKUP_CLOSED:
            case DynamicWriteXML.STATUS_TEXT_WRITTEN:
            case DynamicWriteXML.STATUS_COMMENT_WRITTEN:
                ...
                this.bufferedWriter.write(">");
                break;
            case DynamicWriteXML.STATUS_MARKUP_OPENED:
                if (this.markups.isEmpty())
                {
                    throw new IllegalStateException("No markup to close");
                }
