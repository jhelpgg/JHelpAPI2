        ...
        extends ClassLoader
{
    ...
    {
        final File file = new File(UtilIO.obtainTemporaryDirectory(),
                                   UtilText.concatenate("EmptyClassLoader", File.separator, "file",
     ...
     *
     * @param jarsToMock Jars to see as empty
     */
     ...
     *
     * @param internal      Indicates if class is internal
     * @param decal         Start of each line
     * @param name          Class name
     * @param stringBuilder Where append
     * @param classInJar    Class to append
     * @param simpleName    Short name of class
     * @throws ClassNotFoundException If class not found
     */
    private void appendContent(
            final boolean internal, final String decal, final String name, final StringBuilder stringBuilder,
     ...
     *
     * @param decal         Add start of each line
     * @param stringBuilder Where append
     * @param name          Class name
     * @throws ClassNotFoundException If class not found
     */
    private void appendInternal(final String decal, final StringBuilder stringBuilder, final String name)
            throws ClassNotFoundException
    {
        ...
        for (final String nameInternal : this.jarClassLoader.listOfDirectInternal(name))
        {
            ...
            this.appendContent(true, decal, nameInternal, stringBuilder, this.jarClassLoader.loadClass(nameInternal),
                               simpleName);
     ...
     *
     * @param name        Class to compile
     * @param needCompile Need to compile list
     * @throws ClassNotFoundException If class not found
     */
    private void compileClass(String name, final HashSet<NameCode> needCompile) throws ClassNotFoundException
    {
        ...
        try
        {
            ...
            for (final String imp : imports)
            {
                ...
                {
                    if ((imp.startsWith("java.") == false) && (imp.startsWith("javax.") == false) &&
                        (imp.startsWith("com.sun.") == false)
            ...
            Debug.verbose();
            Debug.verbose("**** Code generated for : ", name, " *****");
            Debug.verbose(stringBuilder.toString());
            Debug.verbose("******************************************");
            Debug.verbose();
     ...
     * @param name       Class name
     * @param imports    List import to fill
     * @param classInJar Class
     * @throws ClassNotFoundException if class not found
     */
    private void fillImports(
            final String base, final String name, final HashSet<String> imports, final Class<?> classInJar)
            throws ClassNotFoundException
    {
     ...
     * @param resolve Indicates if need to resolve
     ...
     *
     * @param name    Class name
     * @param resolve Indicates if class need to be resolved
     * @return Loaded class
     * @throws ClassNotFoundException If class not found
    ...
    protected synchronized Class<?> loadClass(final String name, final boolean resolve) throws ClassNotFoundException
    {
        ...
        if ((name.startsWith("java.") == true) || (name.startsWith("javax.") == true) ||
            (name.startsWith("com.sun.") == true)
