        ...
        implements Animation
{
    ...
    public static void main(final String[] args)
    {
        ...
        try
        {
            final Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES,
                                                MorphSample.RESOURCES.obtainResourceStream("floor068.jpg"));
    ...
    {
        final float t = (float) Math2.moduloInterval((absoluteFrame - this.startAbsoluteFrame) / 100.0, -1, 1);
