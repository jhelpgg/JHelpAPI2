        ...
        implements Object2DListener
{
    ...
    public static void main(final String[] args)
    {
        ...
        final Object3D knot = new Equation3D(path, 16, -Math3D.PI, Math3D.PI, Math3D.PI / 64f, "2*(sin(t)+2*sin(2*t))",
                                             "2*(cos(t)-2*cos(2*t))", "2*(-sin(3*t))");
        ...
        try
        {
            Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES,
                                          SampleObject2D.RESOURCES.obtainResourceStream("floor068.jpg"));
            material.setTextureDiffuse(texture);

            texture = new Texture("TextureSpherique", Texture.REFERENCE_RESOURCES,
                                  SampleObject2D.RESOURCES.obtainResourceStream("001-Fog01.png"));
            material.setTextureSpheric(texture);
            material.setSphericRate(0.25f);

            texture = new Texture("TextureDiffuse2", Texture.REFERENCE_RESOURCES,
                                  SampleObject2D.RESOURCES.obtainResourceStream("B100M801.BMP"));
        }
