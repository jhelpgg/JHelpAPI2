...
public class BumpSample
{
    ...
    public static void main(final String[] args)
    {
        ...
        try
        {
            final Texture textureBump = new Texture("TextureBump", Texture.REFERENCE_RESOURCES,
                                                    BumpSample.RESOURCES.obtainResourceStream("flames.png"));
            final Texture textureFloor = new Texture("TextureFloor", Texture.REFERENCE_RESOURCES,
                                                     BumpSample.RESOURCES.obtainResourceStream("floor068.jpg"));
            material.setTextureDiffuse(Tool3D.obtainBumpTexture(textureFloor, textureBump, 0.55f, 0.01f, 1, 1));

            final Texture textureSphere = new Texture("textureSphere", Texture.REFERENCE_RESOURCES,
                                                      BumpSample.RESOURCES.obtainResourceStream("001-Fog01.png"));
