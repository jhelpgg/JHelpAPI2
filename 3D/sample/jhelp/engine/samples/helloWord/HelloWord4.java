    ...
    public static void main(final String[] args)
    {
        ...
        try
        {
            Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES,
                                          HelloWord4.RESOURCES.obtainResourceStream("floor068.jpg"));
            material.setTextureDiffuse(texture);

            texture = new Texture("TextureCubique", Texture.REFERENCE_RESOURCES,
                                  HelloWord4.RESOURCES.obtainResourceStream("uffizi_cube.jpg"));
