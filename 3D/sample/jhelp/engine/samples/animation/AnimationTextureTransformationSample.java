    ...
    public static void main(final String[] args)
    {
        ...
        try
        {
            final Texture texture1 = new Texture("TextureDiffuse1", Texture.REFERENCE_RESOURCES,
                                                 AnimationTextureTransformationSample.RESOURCES.obtainResourceStream(
                                                         "floor068.jpg"));
            final AnimationTextureTransformation animationTextureTransformation = new AnimationTextureTransformation(
                    texture1);
