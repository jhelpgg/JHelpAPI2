    ...
    public static void main(final String[] args)
    {
        ...
        try
        {
            Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES,
                                          AnimationKeyFrameSample.RESOURCES.obtainResourceStream("floor068.jpg"));
            material.setTextureDiffuse(texture);

            texture = new Texture("TextureSpherique", Texture.REFERENCE_RESOURCES,
                                  AnimationKeyFrameSample.RESOURCES.obtainResourceStream("emerald_bk.jpg"));
        ...
        AnimationKeyFrameSample.animationPositionNode.addFrame(2000,
                                                               new PositionNode(0, 0, 0, 0, 0, 0, 0.75f, 0.5f, 2f));
