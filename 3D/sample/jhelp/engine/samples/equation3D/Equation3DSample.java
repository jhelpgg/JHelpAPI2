...
public class Equation3DSample
{
    ...
    public static void main(final String[] args)
    {
        ...
        final Object3D spiral = new Equation3D(path, 16, -2 * Math3D.TWO_PI, 2 * Math3D.TWO_PI, Math3D.PI / 32f,
                                               "10*cos(t)", "10*sin(t)", "t");
        ...
        try
        {
            Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES,
                                          Equation3DSample.RESOURCES.obtainResourceStream("floor068.jpg"));
            material.setTextureDiffuse(texture);

            texture = new Texture("TextureSpherique", Texture.REFERENCE_RESOURCES,
                                  Equation3DSample.RESOURCES.obtainResourceStream("emerald_bk.jpg"));
