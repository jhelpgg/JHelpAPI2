        ...
        implements NodeListener, PickUVlistener
{
    ...
    public static void main(final String[] args)
    {
        ...
        try
        {
            Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES,
                                          MouseDetectionPrecise.RESOURCES.obtainResourceStream("floor068.jpg"));
            material.setTextureDiffuse(texture);

            texture = new Texture("TextureSpherique", Texture.REFERENCE_RESOURCES,
                                  MouseDetectionPrecise.RESOURCES.obtainResourceStream("emerald_bk.jpg"));
    ...
    {
        Debug.verbose("Pick (", u, ", ", v, ") on ", node);
