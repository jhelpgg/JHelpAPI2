        ...
        implements Runnable
{
     ...
     * You can use it now.
     *
     * @param name        Name give to the texture
     * @param inputStream Stream where the texture is
     * @return The texture auto update when loading is done
     * @throws IOException On reading problem
     */
    public Texture loadTexture(final String name, final InputStream inputStream)
    {
     ...
     * @param name         Name give to the texture
     * @param inputStream  Stream where the texture is
     * @param defaultColor The color use on the texture until it is loading
     * @return The texture auto update when loading is done
     * @throws IOException On reading problem
     */
    public Texture loadTexture(final String name, final InputStream inputStream, final Color defaultColor)
    {
    ...
    public void run()
    {
        ...
        // For each stream
        while ((this.thread != null) && (this.streams.empty() == false))
        {
            // Get the stream
