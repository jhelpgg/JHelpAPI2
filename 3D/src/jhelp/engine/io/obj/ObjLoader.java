...
public class ObjLoader
{
     ...
     * @param reveseNormals Indicates if normal have to be reversed
     * @return Created/modified object
     * @throws IOException On stream read issue
     */
    public static Object3D loadObj(Object3D object3D, final InputStream inputStream, final boolean reveseNormals)
            throws IOException
    {
        if (object3D == null)
        {
        ...
        while (line != null)
        {
            ...
            if ((line.length() > 0) && (line.charAt(0) != '#'))
            {
                ...
                if ((word.equals("g") == true) || (word.equals("o") == true))
                {
                    ...
                    {
                        Mesh.fillObjectOBJ(edit, points, normals, uv, pointFace, normalFace, uvFace, startPoint,
                                           startUV, startNormal);
        ...
        if (pointFace.getSize() > 0)
        {
            Mesh.fillObjectOBJ(edit, points, normals, uv, pointFace, normalFace, uvFace, startPoint, startUV,
                               startNormal);
        }
