...
final class NativeLibInfo
{
    ...
    public final static String getJarFileName()
    {
        ...
        if (nativeLibInfo.isMacOS() == false)
        {
            ...
            {
                Debug.error(error, "jawt not load !");
            }
        }
        // return the name
     ...
     * @param osNameAndArchPair Pair OS name, architecture
     * @param nativePrefix      Native prefix
     * @param nativeSuffix      Native suffix
     */
    private NativeLibInfo(
            final String osName, final String osArch, final String osNameAndArchPair, final String nativePrefix,
            final String nativeSuffix)
    {
        this.osName = osName;
        this.osArch = osArch;
     ...
     *
     * @param nativeJarPattern Pattern to format
    ...
    {
        return fileName.toLowerCase().endsWith(this.nativeSuffix);
    }
    ...
    public boolean matchesOSAndArch(final String osName, final String osArch)
    {
        ...
        {
            return (this.osArch == null) || (osArch.toLowerCase().equals(this.osArch));
        }
        return false;
    }
