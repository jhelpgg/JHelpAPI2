...
public class TextIn3DUtil
{
    ...
    public static Texture createTextTexture(
            final String text, final Font font, final TextAlignment textAlignment, final Color foreGround,
    ...
    public static Texture createTextTexture(
            final String[] lines, final Font font, final TextAlignment textAlignment, final Color foreGround,
            final Color backGround)
    {
        Texture     texture;
        int         length;
     ...
     */
    public static Object2D creteTextObject2D(
            final int x, final int y, final String text, final Font font, final TextAlignment textAlignment,
     ...
     */
    public static Object2D creteTextObject2D(
            final int x, final int y, final String[] lines, final Font font, final TextAlignment textAlignment,
            final Color foreGround, final Color backGround)
    {
        Texture  texture;
        Object2D object2D;
