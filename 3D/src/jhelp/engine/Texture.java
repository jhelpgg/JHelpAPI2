...
public class Texture
{
    ...
    private void drawImage(
            final int x, final int y, final int[] pixels, final int width, final int height,
    ...
    private void fillWithMix(
            final Shape shape, final byte r, final byte g, final byte b, final byte a, final int x, final int y,
            final int width,
            final int height)
    {
        int       line  = (x + (y * this.width)) << 2;
    ...
    public void bind(final GL gl)
    {
        ...
        if (this.needToRefresh == true)
        {
            ...
            gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, this.width, this.height, 0, GL.GL_RGBA,
                            GL.GL_UNSIGNED_BYTE, BufferUtils.transferByte(this.pixels));
        }
        // Draw the texture
        gl.glBindTexture(GL.GL_TEXTURE_2D, this.videoMemoryId);
     ...
     */
    public void draw(
            final GlyphVector glyph, final int x, final int y, final Color color, final boolean mix,
            final int precision)
    {
    ...
    public void drawRect(
            final int x, final int y, final int width, final int height, final Color color, final boolean mix)
    {
    ...
    public void drawString(
            final int x, final int y, final String text, final Color color, final Font font, final boolean mix,
            final int precision)
    {
    ...
    public void drawTexture(
            final int x, final int y, final Texture texture, int xTexture, int yTexture, int width, int height)
    {
        byte[] pixels;
        int    nb;
        int    yy;
    ...
    public void fillRect(
            int x, int y, int width, int height, final Color colorTopLeft, final Color colorTopRight,
     ...
     *
     * @param texture Texture to ccompre with
