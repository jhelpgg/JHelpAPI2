        ...
        implements GLUtessellatorCallback
{
        ...
        if ((v0 != null) && (v1 != null))
        {
            if ((v2 != null) && (v3 != null))
            {
                newVertex.setPosition(
                        ((weight[0] * v0.getPosition().getX()) + (weight[1] * v1.getPosition().getX()) +
                         (weight[2] * v2.getPosition().getX()) + (weight[3] * v3.getPosition().getX())),
                        ((weight[0] * v0.getPosition().getY()) + (weight[1] * v1.getPosition().getY()) +
                         (weight[2] * v2.getPosition().getY()) + (weight[3] * v3.getPosition().getY())),
                        ((weight[0] * v0.getPosition().getZ()) + (weight[1] * v1.getPosition().getZ()) +
                         (weight[2] * v2.getPosition().getZ()) + (weight[3] * v3.getPosition().getZ())));
                newVertex.setUV(
                        ((weight[0] * v0.getUv().getX()) + (weight[1] * v1.getUv().getX()) +
                         (weight[2] * v2.getUv().getX()) + (weight[3] * v3.getUv().getX())),
                        ((weight[0] * v0.getUv().getY()) + (weight[1] * v1.getUv().getY()) +
                         (weight[2] * v2.getUv().getY()) + (weight[3] * v3.getUv().getY())));
                newVertex.setNormal(
                        ((weight[0] * v0.getNormal().getX()) + (weight[1] * v1.getNormal().getX()) +
                         (weight[2] * v2.getNormal().getX()) + (weight[3] * v3.getNormal().getX())),
                        ((weight[0] * v0.getNormal().getY()) + (weight[1] * v1.getNormal().getY()) +
                         (weight[2] * v2.getNormal().getY()) + (weight[3] * v3.getNormal().getY())),
    ...
    public void combineData(
            final double[] coords, final Object[] data, final float[] weight, final Object[] outData,
