...
public class CubeMap
{
    ...
    public void bind(final GL gl)
    {
        ...
        if (this.neeedRefresh == true)
        {
            ...
            gl.glTexImage2D(GL.GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, GL.GL_RGBA, this.xPositive.width,
                            this.xPositive.height, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
                            BufferUtils.transferByte(this.xPositive.pixels));
            gl.glTexImage2D(GL.GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, GL.GL_RGBA, this.xNegative.width,
                            this.xNegative.height, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
                            BufferUtils.transferByte(this.xNegative.pixels));

            gl.glTexImage2D(GL.GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, GL.GL_RGBA, this.yPositive.width,
                            this.yPositive.height, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
                            BufferUtils.transferByte(this.yPositive.pixels));
            gl.glTexImage2D(GL.GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, GL.GL_RGBA, this.yNegative.width,
                            this.yNegative.height, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
                            BufferUtils.transferByte(this.yNegative.pixels));

            gl.glTexImage2D(GL.GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, GL.GL_RGBA, this.zPositive.width,
                            this.zPositive.height, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
                            BufferUtils.transferByte(this.zPositive.pixels));
            gl.glTexImage2D(GL.GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, GL.GL_RGBA, this.zNegative.width,
                            this.zNegative.height, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
    ...
    {
        return (this.xNegative != null) && (this.xPositive != null) && (this.yNegative != null) &&
               (this.yPositive != null) && (this.zNegative != null)
               && (this.zPositive != null);
    }
