        ...
        extends Component
{
    ...
    protected void paintComponent(final Texture texture, final int x, final int y)
    {
        ...
        if (this.clicked == true)
        {
            ...
            texture.drawLine(x + 2, (y + this.height) - 1, (x + this.width) - 1, (y + this.height) - 1,
                             ColorsUtil.LIGHT, true);
            texture.drawLine((x + this.width) - 1, y + 2, (x + this.width) - 1, (y + this.height) - 1, ColorsUtil.LIGHT,
                             true);
        ...
        else
        {
            ...
            texture.drawLine(x + 2, (y + this.height) - 1, (x + this.width) - 1, (y + this.height) - 1,
                             ColorsUtil.SHADOW_DARK, true);
            texture.drawLine((x + this.width) - 1, y + 2, (x + this.width) - 1, (y + this.height) - 1,
                             ColorsUtil.SHADOW_DARK, true);
        }
    }
