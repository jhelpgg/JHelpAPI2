        ...
        implements NodeListener, PickUVlistener
{
     ...
     */
    private final RunnableTask delayedRefresh = new RunnableTask()
    {
        @Override
        public void run()
        {
     ...
     * @param object Object to apply the window
     */
     ...
     *
     * @param mainComponent New mainComponent value
     */
     ...
     *
     * @param textureBackground New textureBackground value
     */
     ...
     *
     * @param node        Node where click
     * @param leftButton  Indicates if mouse left button is down
    ...
    public void refreshIfNeed()
    {
        ...
        {
            ThreadManager.parallel(this.delayedRefresh);
        }
     ...
     *
     * @param sceneRenderer New sceneRenderer value
     */
