        ...
        extends JHelpPanel2D
{
            ...
            implements JHelpSpinner2DListener<Integer>, JHelpActionListener
    {
        ...
        public void actionAppend(final JHelpComponent2D component2d, final int identifier)
        {
            switch (identifier)
            {
                case JHelpPathEditor.ID_ADD_LINE:
                    JHelpPathEditor.this.labelPath.addLine();
                    break;
                case JHelpPathEditor.ID_ADD_CUBIC:
                    JHelpPathEditor.this.labelPath.addCubic();
                    break;
                case JHelpPathEditor.ID_ADD_QUADRIC:
                    JHelpPathEditor.this.labelPath.addQuadric();
                    break;
                case JHelpPathEditor.ID_REMOVE_SELECTED:
    ...
    public JHelpPathEditor()
    {
        ...
        this.panel2dAdditonal.addComponent2D(this.createButton("Add line", JHelpPathEditor.ID_ADD_LINE),
                                             JHelpVerticalLayoutConstraints.EXPANDED);
        this.panel2dAdditonal.addComponent2D(this.createButton("Add quadric", JHelpPathEditor.ID_ADD_QUADRIC),
                                             JHelpVerticalLayoutConstraints.EXPANDED);
        this.panel2dAdditonal.addComponent2D(this.createButton("Add cubic", JHelpPathEditor.ID_ADD_CUBIC),
                                             JHelpVerticalLayoutConstraints.EXPANDED);
        this.panel2dAdditonal.addComponent2D(this.createButton("Delete", JHelpPathEditor.ID_REMOVE_SELECTED),
                                             JHelpVerticalLayoutConstraints.EXPANDED);
    ...
    {
        final JHelpLabelImage2D labelImage2D = JHelpLabelImage2D.createTextLabel(text, JHelpPathEditor.FONT, 0xFF000000,
                                                                                 0xFFFFFF, JHelpTextAlign.CENTER);
     ...
     *           Constraints to use
     */
    public void addAdditonalComponent(
            final JHelpComponent2D component2d, final JHelpVerticalLayoutConstraints constraints)
    {
