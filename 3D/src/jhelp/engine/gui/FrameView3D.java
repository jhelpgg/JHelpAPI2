        ...
        extends JFrame
{
            ...
            implements MouseListener, MouseMotionListener, MouseWheelListener
    {
        ...
        public void mouseClicked(final MouseEvent e)
        {
            ...
            if (e.isAltDown() == true)
            {
                Debug.information(new PositionNode(FrameView3D.this.manipulatedNode));
            }

            FrameView3D.this.componentView3D.getSceneRenderer()
                                            .setDetectPosition(e.getX(), e.getY(), this.left, this.right, false);
        }
        ...
        public void mouseEntered(final MouseEvent e)
        {
            ...
            FrameView3D.this.componentView3D.getSceneRenderer()
                                            .setDetectPosition(e.getX(), e.getY(), false, false, false);
        }
        ...
        public void mouseDragged(final MouseEvent e)
        {
            if (FrameView3D.this.manipulatedNode != null)
            {
                ...
                {
                    FrameView3D.this.manipulatedNode.translate((e.getX() - this.x) * 0.1f, (this.y - e.getY()) * 0.1f,
                                                               0);
                }
                else if (left == true)
                {
            ...
            FrameView3D.this.componentView3D.getSceneRenderer()
                                            .setDetectPosition(e.getX(), e.getY(), this.left, this.right, true);
        }
     ...
     * Constructs FrameView3D
     *
     * @param width  3D area width
     * @param height 3D area height
     */
     ...
     *
     * @param manipulatedNode New manipulatedNode value
     */
