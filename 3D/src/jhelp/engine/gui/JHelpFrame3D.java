        ...
        implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, NodeListener
{
     ...
     *
     * @throws HeadlessException On construction problem
     */
    public JHelpFrame3D()
     ...
     * Constructs the frame
     *
     * @param resizable  Indicates if the frame is resizable
     * @param undecrored Indicates if the frame is undecrored
     * @throws HeadlessException On construction problem
     */
     ...
     */
    public JHelpFrame3D(
            final int width, final int height, final boolean resizable, final String title, final boolean undecrored)
            throws HeadlessException
    {
        if (title != null)
        {
    ...
    void runRobot()
    {
        ...
        if (this.robot != null)
        {
            final BufferedImage screenShot = this.robot.createScreenCapture(
     ...
     *
     * @param defaultMouvment New default movement state
     */
     ...
     *
     * @param enableEvents New enable event state
     */
        ...
        if (this.defaultMouvment == true)
        {
            ...
            switch (e.getKeyCode())
            {
                ...
                case KeyEvent.VK_H:
                    ...
                    break;
                case KeyEvent.VK_P:
                    Debug.information("(", root.getX(), "f, ", root.getY(), "f, " + root.getZ(), "f) | AngleX=",
                                      root.getAngleX(), "f | AngleY=", root.getAngleY(), "f | AngleZ=",
                                      root.getAngleZ(), "f");
                    break;
            }
        }
    ...
    {
        Debug.information("JHelpFrame.mouseClick() : node=", node, " leftButton=", leftButton, " rightButton=",
                          rightButton);
    }
    ...
    {
        Debug.information("JHelpFrame.mouseEnter() : node=", node);
    }
    ...
    {
        Debug.information("JHelpFrame.mouseExit() : node=" + node);
    }
