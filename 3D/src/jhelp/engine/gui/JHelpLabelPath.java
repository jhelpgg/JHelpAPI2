        ...
        extends JHelpComponent2D
{
            ...
            implements JHelpMouseListener
    {
        ...
        {
            JHelpLabelPath.this.mouseX = (
                    ((float) e.getX() - (float) JHelpLabelPath.SIZE_2 - JHelpLabelPath.ANCHOR_SIZE_2) /
                    JHelpLabelPath.SIZE_2);
            JHelpLabelPath.this.mouseY = (((-(float) e.getY() + JHelpLabelPath.SIZE_2) + JHelpLabelPath.ANCHOR_SIZE_2) /
                                          JHelpLabelPath.SIZE_2);
        }
        ...
        public void mouseClicked(final MouseEvent e)
        {
            ...
            {
                final ArrayList<Couple> list = JHelpLabelPath.this.path.obtainCoupleNear(JHelpLabelPath.this.mouseX,
                                                                                         JHelpLabelPath.this.mouseY,
    ...
    public JHelpLabelPath()
    {
        ...
        this.mouseListener(this.eventManager);
    }
    ...
    void updateImagePath()
    {
        synchronized (this.imagePath)
        {
            ...
            if (this.path != null)
            {
                ...
                {
                    this.imagePath.drawLine(
                            (int) (JHelpLabelPath.SIZE_2 + (JHelpLabelPath.SIZE_2 * line2d.pointStart.getX())),
                            JHelpLabelPath.SIZE
                            - (int) (JHelpLabelPath.SIZE_2 + (JHelpLabelPath.SIZE_2 * line2d.pointStart.getY())),
                            (int) (JHelpLabelPath.SIZE_2 + (JHelpLabelPath.SIZE_2 * line2d.pointEnd.getX())),
                            JHelpLabelPath.SIZE
                            - (int) (JHelpLabelPath.SIZE_2 + (JHelpLabelPath.SIZE_2 * line2d.pointEnd.getY())),
                            0xFF0000FF);
                }
                ...
                for (final Point2D point2d : this.path.obtainControlPoints())
                {
                    ...
                    this.imagePath.drawRectangle(x - JHelpLabelPath.ANCHOR_SIZE_2, y - JHelpLabelPath.ANCHOR_SIZE_2,
                                                 JHelpLabelPath.ANCHOR_SIZE,
     ...
     * {@inheritDoc}
     *
     * @param parentWidth  Parent width (-1 if unknow)
     ...
     * {@inheritDoc}
     *
     * @param x      X location on image parent
     * @param y      Y location on image parent
    ...
    {
        this.path.appendCubic(new Point2D(this.mouseX, this.mouseY), new Point2D(this.mouseX, this.mouseY),
                              new Point2D(this.mouseX, this.mouseY), new Point2D(
    ...
    {
        this.path.appendQuad(new Point2D(this.mouseX, this.mouseY), new Point2D(this.mouseX, this.mouseY),
                             new Point2D(this.mouseX, this.mouseY));
        this.fromClick = false;
        this.indexSelected = 0;
        this.selectedPath = this.path.obtainPathElement(this.path.countPathElement() - 1);
        this.updateImagePath();
