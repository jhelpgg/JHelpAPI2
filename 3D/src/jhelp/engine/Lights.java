...
public class Lights
{
    ...
    public int createNewDirectional(
            final String name, final Color4f ambiant, final Color4f diffuse, final Color4f specular,
    ...
    public int createNewSpot(
            final String name, final Color4f ambiant, final Color4f diffuse, final Color4f specular,
            final Point3D position,
            final Point3D direction, final int exponent, final int cutOff, final float constantAttenuation,
