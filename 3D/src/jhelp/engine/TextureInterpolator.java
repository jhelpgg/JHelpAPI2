...
public class TextureInterpolator
{
    ...
    public TextureInterpolator(
            final Texture textureStart, final Texture textureEnd, final String name, final double factor,
     ...
     */
    public TextureInterpolator(
            final Texture textureStart, final Texture textureEnd, final String name,
            final InterpolationType interpolationType)
    {
