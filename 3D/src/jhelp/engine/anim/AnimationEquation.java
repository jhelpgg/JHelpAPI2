        ...
        implements Animation
{
     ...
     *           Node to move
     */
    public AnimationEquation(
            final Function functionX, final Function functionY, final Function functionZ, final float tMin,
            final float tMax,
            final int numberOfFrame, final Node nodeMoved)
    {
        if (functionX == null)
        {
            throw new NullPointerException("functionX mustn't be null");
        }

        if (functionY == null)
        {
            throw new NullPointerException("functionY mustn't be null");
        }

        if (functionZ == null)
        {
            throw new NullPointerException("functionZ mustn't be null");
        }

        if (nodeMoved == null)
        {
            throw new NullPointerException("nodeMoved mustn't be null");
        }
    ...
    public boolean animate(final GL gl, final float absoluteFrame)
    {
        ...
        {
            final float x = (float) this.functionX.replace(AnimationEquation.T, this.tMax)
                                                  .simplifyMaximum()
                                                  .obtainRealValueNumber();
            final float y = (float) this.functionY.replace(AnimationEquation.T, this.tMax)
                                                  .simplifyMaximum()
                                                  .obtainRealValueNumber();
            final float z = (float) this.functionZ.replace(AnimationEquation.T, this.tMax)
                                                  .simplifyMaximum()
                                                  .obtainRealValueNumber();
        ...
        final float x = (float) this.functionX.replace(AnimationEquation.T, t)
                                              .simplifyMaximum()
                                              .obtainRealValueNumber();
        final float y = (float) this.functionY.replace(AnimationEquation.T, t)
                                              .simplifyMaximum()
                                              .obtainRealValueNumber();
        final float z = (float) this.functionZ.replace(AnimationEquation.T, t)
                                              .simplifyMaximum()
                                              .obtainRealValueNumber();
    ...
    public void setStartAbsoluteFrame(final float startAbsoluteFrame)
    {
        ...
        final float x = (float) this.functionX.replace(AnimationEquation.T, this.tMin)
                                              .simplifyMaximum()
                                              .obtainRealValueNumber();
        final float y = (float) this.functionY.replace(AnimationEquation.T, this.tMin)
                                              .simplifyMaximum()
                                              .obtainRealValueNumber();
        final float z = (float) this.functionZ.replace(AnimationEquation.T, this.tMin)
                                              .simplifyMaximum()
                                              .obtainRealValueNumber();
