        ...
        implements Animation
{
     ...
     */
    public static AnimationTexture graySwitch(
            final int numberOfFrame, final Texture texture, final boolean pingPong, final int numberOfLoop,
    ...
    public AnimationTexture(
            final int numberOfFrame, final Texture textureStart, final Texture textureEnd, final boolean pingPong)
    {
            ...
            final InterpolationType interpolationType)
    {
        ...
        this.textureInterpolator = new TextureInterpolator(textureStart, textureEnd,
                                                           textureStart.getTextureName() + "_" +
                                                           textureEnd.getTextureName()
     ...
     */
    public AnimationTexture(
            final int numberOfFrame, final Texture textureStart, final Texture textureEnd,
            final InterpolationType interpolationType)
    {
