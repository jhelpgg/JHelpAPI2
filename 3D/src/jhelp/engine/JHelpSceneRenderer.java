...
import jhelp.engine.anim.ExternalAnimation;
import jhelp.engine.anim.GenericAnimation;
        ...
        implements GLEventListener, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, Runnable
{
    ...
    static class DetectionInfo
    {
         ...
         */
        DetectionInfo(
                final Object2D object2dDetect, final GUI2D gui2d, final int detectX, final int detectY,
    ...
    class FireEventScheduleAction
            implements ConsumerTask<Integer>
    {
        /**
         ...
         */
        @Override
        public void consume(final Integer actionID)
        {
            for (final JHelpSceneRendererListener sceneRendererListener : JHelpSceneRenderer.this.sceneListeners.toArray(
                    new JHelpSceneRendererListener[JHelpSceneRenderer.this.sceneListeners.size()]))
            {
                switch (actionID)
                {
            ...
            implements ConsumerTask<DetectionInfo>
    {
        ...
        {
            detectionInfo.gui2d.mouseState(detectionInfo.detectX, detectionInfo.detectY, detectionInfo.mouseButtonLeft,
        ...
        public void consume(final DetectionInfo detectionInfo)
        {
            ...
            else if (!detectionInfo.mouseDrag)
            {
                ...
                if ((detectionInfo.nodeDetect == null) &&
                    (detectionInfo.mouseButtonLeft || detectionInfo.mouseButtonRight))
                {
                    JHelpSceneRenderer.this.fireClickInSpace(detectionInfo.detectX, detectionInfo.detectY,
    ...
    private void drawOver3D(final GL gl, final GLU glu)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (texture != null)
            {
                this.show2D(gl, glu, texture, object2D.getX(), object2D.getY(), object2D.getWidth(),
                            object2D.getHeight());
            }
        }
    }
     ...
     *
     * @param gl     OpenGL context
     * @param invert Indicates if vertical flip is apply to the shot
     */
     ...
     * @param glu    GLU context
     * @param camera Camera reference for compute mirrors
     */
        ...
        synchronized (this.mirors)
        {
            ...
            for (final Miror miror : this.mirors)
            {
                ...
                if (texture != null)
                {
                    ...
                    gl.glClearColor(miror.backgroundRed, miror.backgroundGreen, miror.backgroundBlue,
                                    miror.backgroundAlpha);
                    ...
                    gl.glReadPixels(128, 128, this.width - 256, this.height - 256, GL.GL_RGBA, GL.GL_BYTE,
                                    BufferUtils.TEMPORARY_BYTE_BUFFER);
     ...
     */
    private void show2D(
            final GL gl, final GLU glu, final Texture texture, final int x, final int y, final int width,
            final int height)
    {
     ...
     */
    void drawPickHotspot(
            final GL gl, final GLU glu, final Node node, final float red, final float green, final float blue)
    {
    ...
    void renderPicking(final GL gl, final GLU glu, final Camera camera)
    {
        ...
        ThreadManager.parallel(this.UPDATE_MOUSE_DETECTION,
                               new DetectionInfo(this.object2DDetect, this.gui2d, this.detectX,
                                                 this.detectY,
                                                 this.mouseButtonLeft, this.mouseButtonRight,
                                                 this.mouseDrag, this.scene, this.nodeDetect));
     ...
     */
    protected void fireClickInSpace(
     ...
     *
     * @param miror Mirror to add
     */
    public void addMiror(final Miror miror)
    {
        if (miror == null)
        {
            throw new NullPointerException("miror mustn't be null");
        }
     ...
     *
     * @param drawable Drawable context
    ...
    public void init(final GLAutoDrawable drawable)
    {
        ...
        ThreadManager.parallel(this.fireEventScheduleAction,
                               JHelpSceneRenderer.ACTION_FIRE_SCENE_RENDERER_IS_INITIALIZED);
    }
    ...
    public void display(final GLAutoDrawable drawable)
    {
        ...
        if ((this.screenShot == null) || (this.screenShot.getWidth() != this.width) ||
            (this.screenShot.getHeight() != this.height))
        {
     ...
     *
     * @param drawable      Drawable context
     * @param modeChanged   Indicates if the mode changed
     * @param deviceChanged Indicates if the device changed
     ...
     *
     * @param showFPS {@code true} to print FPS
     */
     ...
     * @throws Exception On reading issue or if file is not a valid scene
     */
     ...
     *
     * @param millisecond Number of laps time in milliseconds
    ...
    public void playAnimation(final ExternalAnimation externalAnimation)
    {
        this.playAnimation(new GenericAnimation(externalAnimation));
    }
     ...
     *
     * @param sceneRendererListener Listener to register
     */
     ...
     *
     * @param windowMaterial Window material to add
     */
    public void registerWindowMaterial(final WindowMaterial windowMaterial)
    {
        if (windowMaterial == null)
        {
            throw new NullPointerException("windowMaterial mustn't be null");
        }
     ...
     * @param x                X
     * @param y                Y
     * @param mouseButtonLeft  Indicates mouse left button state
     * @param mouseButtonRight Indicates mouse right button state
     * @param mouseDrag        Enable drag mode
     */
    public void setDetectPosition(
            final int x, final int y, final boolean mouseButtonLeft, final boolean mouseButtonRight,
     ...
     *
     * @param sceneRendererListener Listener to unregister
     */
     ...
     *
     * @param windowMaterial Window material to remove
     */
