        ...
        implements Runnable
{
     ...
     * @param textureToRefresh Texture to update on reading
     * @return Encoded image
     * @throws IOException On reading problem
     */
    public static CompressiveImage read(
            final String name, final InputStream inputStream, final Texture textureToRefresh) throws IOException
    {
        if (inputStream == null)
        {
     ...
     *
     * @param outputStream Stream to wite
