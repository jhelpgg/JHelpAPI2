        ...
        extends DrawOnTexture
{
     ...
     */
    OvalOnTexture(
            final int x1, final int y1, final int x2, final int y2, final Color color, final boolean fill,
            final boolean mix)
    {
        this.x1 = x1;
        this.y1 = y1;
    ...
    public void draw(final Texture texture)
    {
        ...
        if (this.fill == true)
        {
            texture.fillOval(Math.min(this.x1, this.x2), Math.min(this.y1, this.y2), Math.abs(this.x1 - this.x2) + 1,
                             Math.abs(this.y1 - this.y2) + 1, this.color,
                             this.mix);
        }
        else
        {
            texture.draw(new Ellipse2D.Double(Math.min(this.x1, this.x2), Math.min(this.y1, this.y2),
