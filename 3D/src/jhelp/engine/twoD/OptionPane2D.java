        ...
        implements Object2DListener
{
     ...
     */
    public OptionPane2D(
            final JHelpSceneRenderer sceneRenderer, final int x, final int y, final int width, final int height,
    ...
    private JHelpImage createOptionPaneButton(final String text)
    {
        ...
        AlphabetGraffiti.NORMAL.drawOn(text, JHelpTextAlign.CENTER, image, image.getWidth() >> 1,
    ...
    private void updateOptionPane(final String text, final OptionPaneButtons optionPaneButtons)
    {
        ...
        switch (optionPaneButtons)
        {
            ...
            case YES_NO:
                ...
                this.yesArea.setBounds(x1, height - imageButton1.getHeight(), imageButton1.getWidth(),
                                       imageButton1.getHeight());
                this.noArea.setBounds(x2, height - imageButton2.getHeight(), imageButton2.getWidth(),
            ...
            case YES_NO_CANCEL:
                ...
                this.noArea.setBounds(x2, height - imageButton2.getHeight(), imageButton2.getWidth(),
                                      imageButton2.getHeight());
                this.cancelArea.setBounds(x3, height - imageButton3.getHeight(), imageButton3.getWidth(),
                                          imageButton3.getHeight());
                break;
            default:
                break;
        }
