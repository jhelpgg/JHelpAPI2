        ...
        implements Object2DListener
{
            ...
            implements ConsumerTask<Pair<Button2D, Button2DListener>>
    {
        ...
        {
            parameter.second.button2DClicked(parameter.first, parameter.first.getButtonID());
        }
    }
     ...
     */
    public Button2D(
            final int buttonID, final int x, final int y, final int width, final int height, final JHelpImage normal)
    {
        ...
        synchronized (this.listeners)
        {
            for (final Button2DListener listener : this.listeners)
            {
                ThreadManager.parallel(Button2D.TASK_FIRE_BUTTON_CLICK,
                                       new Pair<Button2D, Button2DListener>(this, listener));
            }
        }
    }
