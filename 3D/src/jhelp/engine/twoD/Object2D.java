...
public class Object2D
{
    ...
    static class MouseInformation
    {
         ...
         */
        MouseInformation(
                final Object2D object2d, final Object2DListener object2DListener, final int nature, final int x,
                final int y)
        {
            ...
            implements ConsumerTask<MouseInformation>
    {
         ...
         */
        @Override
        public void consume(final MouseInformation parameter)
        {
            switch (parameter.nature)
            {
                case Object2D.CLICK:
                    parameter.object2DListener.mouseClick(parameter.object2d, parameter.x, parameter.y, parameter.left,
                                                          parameter.right);
                    break;
                case Object2D.DRAG:
                    parameter.object2DListener.mouseDrag(parameter.object2d, parameter.x, parameter.y, parameter.left,
                                                         parameter.right);
                    break;
                case Object2D.ENTER:
    ...
    protected void fireMouseClick(final int x, final int y, final boolean leftButton, final boolean rightButton)
    {
        for (final Object2DListener object2DListener : this.arrayListListeners)
        {
            ThreadManager.parallel(Object2D.TASK_FIRE_MOUSE,
                                   new MouseInformation(this, object2DListener, Object2D.CLICK, x, y, leftButton,
                                                        rightButton));
        }
    }
    ...
    protected void fireMouseDrag(final int x, final int y, final boolean leftButton, final boolean rightButton)
    {
        ...
        {
            ThreadManager.parallel(Object2D.TASK_FIRE_MOUSE,
                                   new MouseInformation(this, object2DListener, Object2D.DRAG, x, y, leftButton,
                                                        rightButton));
        }
    }
     ...
     *
     * @param texture New object's texture
     */
