...
public final class Light
{
    ...
    public void makePonctualLight(
            final Point3D position, final int exponent, final float constantAttenuation, final float linearAttenuation,
    ...
    public void makeSpot(
            final Point3D position, final Point3D direction, final int exponent, final int cutOff,
    ...
    public void render(final GL gl)
    {
        if (this.asChanged == true)
        {
            ...
            if (this.needRefresh == true)
            {
                ...
                gl.glLightfv(this.id, GL.GL_SPOT_DIRECTION,
