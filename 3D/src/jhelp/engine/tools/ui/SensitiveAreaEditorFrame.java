        ...
        extends JHelpFrame
{
    ...
    private static final int[] AREA_COLORS =
            {//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_AMBER_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_BLUE_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_BLUE_GREY_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_BROWN_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_CYAN_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_DEEP_ORANGE_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_DEEP_PURPLE_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_GREEN_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_GREY_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_INDIGO_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_LIGHT_BLUE_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_LIGHT_GREEN_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_LIME_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_ORANGE_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_PINK_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_PURPLE_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_RED_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_TEAL_0900),//
             JHelpConstantsSmooth.COLOR_ALPHA_HINT |
             (JHelpConstantsSmooth.MASK_COLOR & JHelpConstantsSmooth.COLOR_YELLOW_0900)//
            };
    /**
     * Font to use
     */
            ...
            implements MouseMotionListener, MouseListener, OverLabelJHelpImage
    {
         ...
         * @param click      Indicates if it is a click
         */
     ...
     *
     * @param graphics Graphics context
     * @param width    Area with
     * @param height   Aera height
     */
    void doDraw(final Graphics graphics, final int width, final int height)
    {
        ...
        for (int index = 0; index < number; index++)
        {
            ...
            if (area == this.overArea)
            {
                ...
                {
                    case DOWN:
                        graphics.fillRect(bounds.x, (bounds.y + bounds.height) - SensitiveAreaEditorFrame.NEAR,
                                          bounds.width, diameter);
                        break;
                    case INSIDE:
                        graphics.fillOval(mx - SensitiveAreaEditorFrame.NEAR, my - SensitiveAreaEditorFrame.NEAR,
                                          diameter, diameter);
                        break;
                    case LEFT:
                        ...
                        break;
                    case LEFT_DOWN:
                        graphics.fillRect(bounds.x - SensitiveAreaEditorFrame.NEAR,
                                          (bounds.y + bounds.height) - SensitiveAreaEditorFrame.NEAR, diameter,
                                          diameter);
                        break;
                    case LEFT_UP:
                        graphics.fillRect(bounds.x - SensitiveAreaEditorFrame.NEAR,
                                          bounds.y - SensitiveAreaEditorFrame.NEAR, diameter, diameter);
                        break;
                    case OUTSIDE:
                        break;
                    case RIGHT:
                        graphics.fillRect((bounds.x + bounds.width) - SensitiveAreaEditorFrame.NEAR, bounds.y, diameter,
                                          bounds.height);
                        break;
                    case RIGHT_DOWN:
                        graphics.fillRect((bounds.x + bounds.width) - SensitiveAreaEditorFrame.NEAR,
                                          (bounds.y + bounds.height) - SensitiveAreaEditorFrame.NEAR,
                                          diameter, diameter);
                        break;
                    case RIGHT_UP:
                        graphics.fillRect((bounds.x + bounds.width) - SensitiveAreaEditorFrame.NEAR,
    ...
    void doLoadImage()
    {
        this.fileChooser.fileFilter(this.fileFilterImage);
        ...
        try
        {
            ...
            this.labelJHelpImage.image(image);
        }
     ...
     * @param x       Mouse X
     * @param y       Mouse Y
     * @param click   Indicates if click
     * @param shift   Indicates if shift down
     * @param control Indicates if control down
     * @param alt     Indicates if alt down
     */
    void doMouse(
            final int x, final int y, final boolean click, final boolean shift, final boolean control,
            final boolean alt)
    {
        if (this.sensitiveArea == null)
        {
        ...
        if (this.area == null)
        {
            ...
            this.overArea = pair.second;
            this.position = pair.first;

            if (click == true)
            {
                this.area = pair.second;
            }
        }
        else if (click == false)
        {
    ...
    void doOpen()
    {
        this.fileChooser.fileFilter(this.fileFilterArea);
        final File file = this.fileChooser.showOpenFile();
        ...
        {
            Debug.exception(exception, "Failed to open ", file.getAbsolutePath());
        }
        finally
        {
            if (inputStream != null)
    ...
    void doSave()
    {
        ...
        {
            Debug.exception(exception, "Failed to save ", file.getAbsolutePath());
        }
        finally
        {
    ...
    protected void addListeners()
    {
        ...
        this.labelJHelpImage.overLabelJHelpImage(this.eventManager);
    }
