        ...
        extends Object3D
{
     ...
     * @param multU             U multiplier (V are carry by the path)
     */
     ...
     * Refresh the revolution's mesh.
     *
     * @param omogeonous Indicates if try to make it omogenous or not
     * @param start      Interpolation value at path start (Available only for omogenous at {@code true})
     * @param end        Interpolation value at path end (Available only for omogenous at {@code true})
     */
    ...
    public void appendCubic(
            final Point2D startPoint, final float start, final Point2D controlPoint1, final float control1,
     ...
     */
    public void appendCubic(
            final Point2D startPoint, final Point2D controlPoint1, final Point2D controlPoint2, final Point2D endPoint)
    {
    ...
    public void appendQuad(
            final Point2D startPoint, final float start, final Point2D controlPoint, final float control,
