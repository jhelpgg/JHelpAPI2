        ...
        extends Object3D
{
            ...
            implements RunnableTask
    {
         ...
         * @param fonctionX       Function of X : x = X(t)
         * @param fonctionY       Function of Y : y = Y(t)
         * @param fonctionZ       Function of Z : z = Z(t)
         */
        Creator(
                final Path border, final int borderPrecision, final float start, final float end, final float step,
     ...
     * @param fonctionX       Function X : x = X(t)
     * @param fonctionY       Function Y : y = Y(t)
     * @param fonctionZ       Function Z : z = Z(t)
     */
    public Equation3D(
            final Path border, final int borderPrecision, final float tStart, final float tEnd, final float tStep,
            final Function fonctionX,
            final Function fonctionY, final Function fonctionZ)
    {
     ...
     * @param fonctionY          Function Y : y = Y(t)
     * @param fonctionZ          Function Z : z = Z(t)
     * @param equation3DListener Listener for know when ready
     */
    public Equation3D(
            final Path border, final int borderPrecision, final float tStart, final float tEnd, final float tStep,
            final Function fonctionX,
            final Function fonctionY, final Function fonctionZ, final Equation3DListener equation3DListener)
    {
        ...
        ThreadManager.parallel(new Creator(border, borderPrecision,
                                           tStart, tEnd, tStep,
                                           fonctionX.simplifyMaximum(),
                                           fonctionY.simplifyMaximum(),
                                           fonctionZ.simplifyMaximum()));
    }
