        ...
        extends Object3D
{
     ...
     * @param multU            U multiplier to repeat texture along the loop
     * @param multV            V multiplier to repeat texture along the "height"
     * @param ribbon3dListener Listener to alert when ribbon finished to create
     */
    public Ribbon3D(
            final int torsioCount, final float multU, final float multV, final Ribbon3DListener ribbon3dListener)
    {
    ...
    public Ribbon3D(
            ...
            final Ribbon3DListener ribbon3dListener)
    {
