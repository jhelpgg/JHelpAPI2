...
public class SensitiveArea
{
            ...
            implements ParseXMLlistener
    {
         ...
         * {@inheritDoc}
         *
         * @param markupName Closed markup
         * @throws ExceptionXML If close that markup now is invalid
         ...
         * {@inheritDoc}
         *
         * @throws ExceptionXML If end parsing now is invalid
         ...
         * {@inheritDoc}
         *
         * @param exceptionParseXML Exception happen
        ...
        {
            Debug.exception(exceptionParseXML, "Parsing area failed");
        }
         ...
         * {@inheritDoc}
         *
         * @param markupName Opened markup name
         * @param parameters Markup parameters
         * @throws ExceptionXML If the markup shouldn't open yet, or unexpected, or one of parameters missing or invalid
        ...
        public void startMarkup(final String markupName, final Hashtable<String, String> parameters) throws ExceptionXML
        {
            ...
            if (this.sensitiveArea == null)
            {
                throw new ExceptionXML(
                        "The " + SensitiveArea.MARKUP_MAIN + " must be the first markup, be we meet " + markupName +
                        " before it");
            }
            ...
            Debug.warning("Don't know what to do with markup ", markupName);
        }
         ...
         * @throws ExceptionXML If text is invalid
     ...
     * @param parameters Markup parameters
     * @return Parsed area
     * @throws ExceptionXML If markup is not an area markup OR one parameter invalid or missing
     */
    public static SensitiveArea createFromMarkup(final String markup, final Hashtable<String, String> parameters)
            throws ExceptionXML
    {
     ...
     * @return Read area
     * @throws ExceptionParseXML If stream not contains valis area
     */
    ...
    public class Area
    {
         ...
         *
         * @param id     Area ID
         * @param x      Area up left corner X
         * @param y      Area up left corner Y
         ...
         *
         * @param developperInformation New developer information
         */
        ...
        public void move(final int x, final int y, final Position position)
        {
            ...
            x1 = Math2.limit(x1, 0, SensitiveArea.this.width - 1);
            y1 = Math2.limit(y1, 0, SensitiveArea.this.height - 1);
            x2 = Math2.limit(x2, 0, SensitiveArea.this.width - 1);
            y2 = Math2.limit(y2, 0, SensitiveArea.this.height - 1);
         ...
         * @param x    Point X
         * @param y    Point Y
         * @param near Distance to consider close
            ...
            implements Object2DListener, NodeListener, PickUVlistener
    {
         ...
         * @param leftButton  Left button down status
         * @param rightButton Right button down status
         ...
         * {@inheritDoc}
         *
         * @param object2d    Clicked object 2D
         * @param x           X position
         * @param y           Y position
         * @param leftButton  Left button down status
         * @param rightButton Right button down status
         ...
         * {@inheritDoc}
         *
         * @param object2d    Dragged object 2D
         * @param x           X position
         * @param y           Y position
         * @param leftButton  Left button down status
         * @param rightButton Right button down status
         ...
         * {@inheritDoc}
         *
         * @param object2d Entered Object 2D
         * @param x        Mouse X
         * @param y        Mouse Y
         ...
         * {@inheritDoc}
         *
         * @param object2d Exited Object 2D
         * @param x        Mouse X
         * @param y        Mouse Y
     ...
     * @param x        Position X
     * @param y        Position Y
     * @param doAction Indicates if click should be fire
     */
     ...
     *
     * @param developperInformation Developer information
     */
    public void setDevelopperInformation(final Object developperInformation)
    {
        this.developperInformation = developperInformation;
     ...
     *
     * @param sceneRenderer Scene renderer parent
    ...
    public void putArea(final int areaID, final int x, final int y, final int width, final int height)
    {
        if (areaID < 0)
        {
            throw new IllegalArgumentException("area ID mustn't be negative");
        }
     ...
     * @param markup     Markup name
     * @param parameters Markup parameters
     * @throws ExceptionXML If markup not an area
     */
     ...
     *
     * @param dynamicWriteXML XML stream where write
     ...
     *
     * @param sensitiveAreaListener Listener to unregister
     */
