...
public interface Object2DListener
{
     ...
     */
    void mouseClick(Object2D object2D, int x, int y, boolean leftButton, boolean rightButton);
     ...
     *           Indicates if the right button is down
     */
    void mouseDrag(Object2D object2D, int x, int y, boolean leftButton, boolean rightButton);
     ...
     *           Mouse Y
     */
    void mouseEnter(Object2D object2D, int x, int y);
     ...
     *           Mouse Y
     */
    void mouseExit(Object2D object2D, int x, int y);
     ...
     *           Mouse Y
     */
    void mouseMove(Object2D object2D, int x, int y);
}