...
public class Scene
{
    ...
    public void loadFromXML(final MarkupXML markupXML) throws Exception
    {
        ...
        color4f = null;
        MarkupXML markup = markupXML.obtainChildren(ConstantsXML.MARKUP_NODE).nextElement();
        this.root.loadFromXML(markup);
        markup = markupXML.obtainChildren(ConstantsXML.MARKUP_CAMERA).nextElement();
     ...
     * @param over        Node that mouse id over
     */
