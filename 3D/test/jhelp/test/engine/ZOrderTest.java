        ...
        implements Object2DListener
{
    ...
    private final RunnableTask threadedLoadOBJ     = ZOrderTest.this::loadOBJ;
    private final RunnableTask threadedLoadTexture = ZOrderTest.this::loadTexture;
    ...
    void loadTexture()
    {
        ...
        if (texture == null)
        {
            ...
            {
                Debug.exception(exception, "Issue while loading texture ", name);
            }
            finally
            {
                if (inputStream != null)
            ...
            final Object2D object2d, final int x, final int y, final boolean leftButton, final boolean rightButton)
    {
        ...
        {
            ThreadManager.parallel(this.threadedLoadOBJ);
        }
        else if (object2d == ZOrderTest.object2dLoadTexture)
        {
            ThreadManager.parallel(this.threadedLoadTexture);
        }
    }
